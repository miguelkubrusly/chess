...
if TYPE_CHECKING:
  from ..models.api_simul_response_200_created_item_host import ApiSimulResponse200CreatedItemHost
  from ..models.api_simul_response_200_created_item_variants_item import ApiSimulResponse200CreatedItemVariantsItem





T = TypeVar("T", bound="ApiSimulResponse200CreatedItem")



@_attrs_define
class ApiSimulResponse200CreatedItem:
    """ 
        Attributes:
            id (str):
            host (ApiSimulResponse200CreatedItemHost):
            name (str):
            full_name (str):
            variants (list['ApiSimulResponse200CreatedItemVariantsItem']):
            is_created (bool):
            is_finished (bool):
            is_running (bool):
            nb_applicants (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host = ApiSimulResponse200CreatedItemHost.from_dict(d.pop("host"))
        ...
        for variants_item_data in (_variants):
            variants_item = ApiSimulResponse200CreatedItemVariantsItem.from_dict(variants_item_data)
        ...
        api_simul_response_200_created_item = cls(
            id=id,
            host=host,
            name=name,
            full_name=full_name,
        ...
        api_simul_response_200_created_item.additional_properties = d
        return api_simul_response_200_created_item
