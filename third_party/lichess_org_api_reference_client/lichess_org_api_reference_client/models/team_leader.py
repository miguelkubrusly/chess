...
from ..models.team_leader_title import TeamLeaderTitle
from ..types import UNSET, Unset
...
class TeamLeader:
    """ 
        Attributes:
            ...
            title (Union[Unset, TeamLeaderTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, TeamLeaderTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, TeamLeaderTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = TeamLeaderTitle(_title)
