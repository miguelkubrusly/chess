...
from ..models.simul_host_title import SimulHostTitle
from ..types import UNSET, Unset
...
class SimulHost:
    """ 
        Attributes:
            ...
            title (Union[Unset, SimulHostTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, SimulHostTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, SimulHostTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = SimulHostTitle(_title)
        ...
        simul_host.additional_properties = d
        return simul_host
