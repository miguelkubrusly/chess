...
T = TypeVar("T", bound="ChallengeEventChallengeRealTime")



@_attrs_define
class ChallengeEventChallengeRealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_event_challenge_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_event_challenge_real_time
