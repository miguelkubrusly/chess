...
if TYPE_CHECKING:
  from ..models.broadcast_top_active_item_tour_info import BroadcastTopActiveItemTourInfo





T = TypeVar("T", bound="BroadcastTopActiveItemTour")



@_attrs_define
class BroadcastTopActiveItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastTopActiveItemTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastTopActiveItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastTopActiveItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastTopActiveItemTourInfo.from_dict(_info)
        ...
        broadcast_top_active_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_top_active_item_tour.additional_properties = d
        return broadcast_top_active_item_tour
