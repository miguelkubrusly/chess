...
T = TypeVar("T", bound="SwissTournamentNextRound")



@_attrs_define
class SwissTournamentNextRound:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        swiss_tournament_next_round = cls(
            at=at,
            in_=in_,
        )


        swiss_tournament_next_round.additional_properties = d
        return swiss_tournament_next_round
