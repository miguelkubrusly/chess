...
if TYPE_CHECKING:
  from ..models.broadcast_with_rounds_rounds_item_custom_scoring import BroadcastWithRoundsRoundsItemCustomScoring





T = TypeVar("T", bound="BroadcastWithRoundsRoundsItem")



@_attrs_define
class BroadcastWithRoundsRoundsItem:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastWithRoundsRoundsItemCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastWithRoundsRoundsItemCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastWithRoundsRoundsItemCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastWithRoundsRoundsItemCustomScoring.from_dict(_custom_scoring)




        broadcast_with_rounds_rounds_item = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_with_rounds_rounds_item.additional_properties = d
        return broadcast_with_rounds_rounds_item
