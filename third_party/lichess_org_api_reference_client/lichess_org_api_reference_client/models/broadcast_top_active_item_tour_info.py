...
from ..models.broadcast_top_active_item_tour_info_fide_tc import BroadcastTopActiveItemTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTopActiveItemTourInfo")



@_attrs_define
class BroadcastTopActiveItemTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTopActiveItemTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTopActiveItemTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTopActiveItemTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTopActiveItemTourInfoFideTc(_fide_tc)
        ...
        broadcast_top_active_item_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_top_active_item_tour_info.additional_properties = d
        return broadcast_top_active_item_tour_info
