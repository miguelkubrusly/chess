...
T = TypeVar("T", bound="UserActivityGamesHordeRp")



@_attrs_define
class UserActivityGamesHordeRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_horde_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_horde_rp.additional_properties = d
        return user_activity_games_horde_rp
