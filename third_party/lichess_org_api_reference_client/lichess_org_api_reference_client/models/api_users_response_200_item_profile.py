...
T = TypeVar("T", bound="ApiUsersResponse200ItemProfile")



@_attrs_define
class ApiUsersResponse200ItemProfile:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_users_response_200_item_profile = cls(
            flag=flag,
            location=location,
            bio=bio,
            real_name=real_name,
        ...
        api_users_response_200_item_profile.additional_properties = d
        return api_users_response_200_item_profile
