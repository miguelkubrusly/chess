...
if TYPE_CHECKING:
  from ..models.api_simul_response_200_finished_item_host import ApiSimulResponse200FinishedItemHost
  from ..models.api_simul_response_200_finished_item_variants_item import ApiSimulResponse200FinishedItemVariantsItem





T = TypeVar("T", bound="ApiSimulResponse200FinishedItem")



@_attrs_define
class ApiSimulResponse200FinishedItem:
    """ 
        Attributes:
            id (str):
            host (ApiSimulResponse200FinishedItemHost):
            name (str):
            full_name (str):
            variants (list['ApiSimulResponse200FinishedItemVariantsItem']):
            is_created (bool):
            is_finished (bool):
            is_running (bool):
            nb_applicants (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host = ApiSimulResponse200FinishedItemHost.from_dict(d.pop("host"))
        ...
        for variants_item_data in (_variants):
            variants_item = ApiSimulResponse200FinishedItemVariantsItem.from_dict(variants_item_data)
        ...
        api_simul_response_200_finished_item = cls(
            id=id,
            host=host,
            name=name,
            full_name=full_name,
        ...
        api_simul_response_200_finished_item.additional_properties = d
        return api_simul_response_200_finished_item
