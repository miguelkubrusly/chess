...
from ..models.tablebase_json_moves_item_category import TablebaseJsonMovesItemCategory
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="TablebaseJsonMovesItem")



@_attrs_define
class TablebaseJsonMovesItem:
    """ 
        Attributes:
            uci (Union[Unset, str]):  Example: h7h8q.
            san (Union[Unset, str]):  Example: h8=Q+.
            category (Union[Unset, TablebaseJsonMovesItemCategory]):
    ...
    category: Union[Unset, TablebaseJsonMovesItemCategory] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_category,  Unset):
            ...
            category = TablebaseJsonMovesItemCategory(_category)
        ...
        tablebase_json_moves_item.additional_properties = d
        return tablebase_json_moves_item
