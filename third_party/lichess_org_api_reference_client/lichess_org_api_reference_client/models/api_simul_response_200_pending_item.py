...
if TYPE_CHECKING:
  from ..models.api_simul_response_200_pending_item_host import ApiSimulResponse200PendingItemHost
  from ..models.api_simul_response_200_pending_item_variants_item import ApiSimulResponse200PendingItemVariantsItem





T = TypeVar("T", bound="ApiSimulResponse200PendingItem")



@_attrs_define
class ApiSimulResponse200PendingItem:
    """ 
        Attributes:
            id (str):
            host (ApiSimulResponse200PendingItemHost):
            name (str):
            full_name (str):
            variants (list['ApiSimulResponse200PendingItemVariantsItem']):
            is_created (bool):
            is_finished (bool):
            is_running (bool):
            nb_applicants (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host = ApiSimulResponse200PendingItemHost.from_dict(d.pop("host"))
        ...
        for variants_item_data in (_variants):
            variants_item = ApiSimulResponse200PendingItemVariantsItem.from_dict(variants_item_data)
        ...
        api_simul_response_200_pending_item = cls(
            id=id,
            host=host,
            name=name,
            full_name=full_name,
        ...
        api_simul_response_200_pending_item.additional_properties = d
        return api_simul_response_200_pending_item
