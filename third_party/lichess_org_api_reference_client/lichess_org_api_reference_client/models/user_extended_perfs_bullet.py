...
T = TypeVar("T", bound="UserExtendedPerfsBullet")



@_attrs_define
class UserExtendedPerfsBullet:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_bullet = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_bullet.additional_properties = d
        return user_extended_perfs_bullet
