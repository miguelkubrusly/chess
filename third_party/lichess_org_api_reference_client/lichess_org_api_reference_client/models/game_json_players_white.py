...
if TYPE_CHECKING:
  from ..models.game_json_players_white_analysis import GameJsonPlayersWhiteAnalysis
  from ..models.game_json_players_white_user import GameJsonPlayersWhiteUser





T = TypeVar("T", bound="GameJsonPlayersWhite")



@_attrs_define
class GameJsonPlayersWhite:
    """ 
        Attributes:
            user (GameJsonPlayersWhiteUser):
            rating (int):
            rating_diff (Union[Unset, int]):
            name (Union[Unset, str]):
            provisional (Union[Unset, bool]):
            ai_level (Union[Unset, int]):
            analysis (Union[Unset, GameJsonPlayersWhiteAnalysis]):
    ...
    analysis: Union[Unset, 'GameJsonPlayersWhiteAnalysis'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.game_json_players_white_user import GameJsonPlayersWhiteUser
        d = dict(src_dict)
        user = GameJsonPlayersWhiteUser.from_dict(d.pop("user"))
        ...
        if isinstance(_analysis,  Unset):
            ...
            analysis = GameJsonPlayersWhiteAnalysis.from_dict(_analysis)
        ...
        game_json_players_white.additional_properties = d
        return game_json_players_white
