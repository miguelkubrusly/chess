...
if TYPE_CHECKING:
  from ..models.team_paginator_json_current_page_results_item_leader import TeamPaginatorJsonCurrentPageResultsItemLeader
  from ..models.team_paginator_json_current_page_results_item_leaders_item import TeamPaginatorJsonCurrentPageResultsItemLeadersItem





T = TypeVar("T", bound="TeamPaginatorJsonCurrentPageResultsItem")



@_attrs_define
class TeamPaginatorJsonCurrentPageResultsItem:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            leader (Union[Unset, TeamPaginatorJsonCurrentPageResultsItemLeader]):
            leaders (Union[Unset, list['TeamPaginatorJsonCurrentPageResultsItemLeadersItem']]):
    ...
    leader: Union[Unset, 'TeamPaginatorJsonCurrentPageResultsItemLeader'] = UNSET
    leaders: Union[Unset, list['TeamPaginatorJsonCurrentPageResultsItemLeadersItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_leader,  Unset):
            ...
            leader = TeamPaginatorJsonCurrentPageResultsItemLeader.from_dict(_leader)
        ...
        for leaders_item_data in (_leaders or []):
            leaders_item = TeamPaginatorJsonCurrentPageResultsItemLeadersItem.from_dict(leaders_item_data)
        ...
        team_paginator_json_current_page_results_item = cls(
            id=id,
            name=name,
        ...
        team_paginator_json_current_page_results_item.additional_properties = d
        return team_paginator_json_current_page_results_item
