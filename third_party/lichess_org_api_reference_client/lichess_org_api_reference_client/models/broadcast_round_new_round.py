...
if TYPE_CHECKING:
  from ..models.broadcast_round_new_round_custom_scoring import BroadcastRoundNewRoundCustomScoring





T = TypeVar("T", bound="BroadcastRoundNewRound")



@_attrs_define
class BroadcastRoundNewRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundNewRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundNewRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundNewRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundNewRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_round_new_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_new_round.additional_properties = d
        return broadcast_round_new_round
