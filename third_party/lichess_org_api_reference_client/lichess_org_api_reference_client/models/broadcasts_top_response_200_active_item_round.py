...
if TYPE_CHECKING:
  from ..models.broadcasts_top_response_200_active_item_round_custom_scoring import BroadcastsTopResponse200ActiveItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastsTopResponse200ActiveItemRound")



@_attrs_define
class BroadcastsTopResponse200ActiveItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastsTopResponse200ActiveItemRoundCustomScoring]): Scoring overrides for wins
                or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastsTopResponse200ActiveItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastsTopResponse200ActiveItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastsTopResponse200ActiveItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcasts_top_response_200_active_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_top_response_200_active_item_round.additional_properties = d
        return broadcasts_top_response_200_active_item_round
