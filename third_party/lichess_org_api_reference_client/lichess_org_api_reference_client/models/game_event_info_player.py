...
T = TypeVar("T", bound="GameEventInfoPlayer")



@_attrs_define
class GameEventInfoPlayer:
    """ 
        Attributes:
            id (str):
            username (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_event_info_player.additional_properties = d
        return game_event_info_player
