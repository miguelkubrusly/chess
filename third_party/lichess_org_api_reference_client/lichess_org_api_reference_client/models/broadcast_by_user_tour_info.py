...
from ..models.broadcast_by_user_tour_info_fide_tc import BroadcastByUserTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastByUserTourInfo")



@_attrs_define
class BroadcastByUserTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastByUserTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastByUserTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastByUserTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastByUserTourInfoFideTc(_fide_tc)
        ...
        broadcast_by_user_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_by_user_tour_info.additional_properties = d
        return broadcast_by_user_tour_info
