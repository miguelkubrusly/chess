...
if TYPE_CHECKING:
  from ..models.broadcast_round_get_response_200_round_custom_scoring import BroadcastRoundGetResponse200RoundCustomScoring





T = TypeVar("T", bound="BroadcastRoundGetResponse200Round")



@_attrs_define
class BroadcastRoundGetResponse200Round:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundGetResponse200RoundCustomScoring]): Scoring overrides for wins or
                draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundGetResponse200RoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundGetResponse200RoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundGetResponse200RoundCustomScoring.from_dict(_custom_scoring)




        broadcast_round_get_response_200_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_get_response_200_round.additional_properties = d
        return broadcast_round_get_response_200_round
