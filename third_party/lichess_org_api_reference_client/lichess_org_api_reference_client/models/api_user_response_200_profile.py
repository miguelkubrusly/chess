...
T = TypeVar("T", bound="ApiUserResponse200Profile")



@_attrs_define
class ApiUserResponse200Profile:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_user_response_200_profile = cls(
            flag=flag,
            location=location,
            bio=bio,
            real_name=real_name,
        ...
        api_user_response_200_profile.additional_properties = d
        return api_user_response_200_profile
