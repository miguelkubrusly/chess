...
if TYPE_CHECKING:
  from ..models.game_user_analysis import GameUserAnalysis
  from ..models.game_user_user import GameUserUser





T = TypeVar("T", bound="GameUser")
...
class GameUser:
    """ 
        Attributes:
            ...
            analysis (Union[Unset, GameUserAnalysis]):
    ...
    analysis: Union[Unset, 'GameUserAnalysis'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.game_user_user import GameUserUser
        d = dict(src_dict)
        user = GameUserUser.from_dict(d.pop("user"))
        ...
        if isinstance(_analysis,  Unset):
            ...
            analysis = GameUserAnalysis.from_dict(_analysis)
        ...
        game_user.additional_properties = d
        return game_user
