...
from ..models.broadcast_round_form_status import BroadcastRoundFormStatus
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastRoundForm")



@_attrs_define
class BroadcastRoundForm:
    """ 
        Attributes:
            ...
            delay (Union[Unset, int]): Delay in seconds for movements to appear on the broadcast. Leave it empty if you
                don't need it.
                Example: `900` (15 min)
            status (Union[Unset, BroadcastRoundFormStatus]): Lichess can usually detect the round status, but you can also
                set it manually if needed.
                 Default: BroadcastRoundFormStatus.NEW.
    ...
    status: Union[Unset, BroadcastRoundFormStatus] = BroadcastRoundFormStatus.NEW
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, BroadcastRoundFormStatus]
        if isinstance(_status,  Unset):
            status = UNSET
        else:
            status = BroadcastRoundFormStatus(_status)
        ...
        broadcast_round_form.additional_properties = d
        return broadcast_round_form
