...
if TYPE_CHECKING:
  from ..models.broadcast_tour_create_response_200_tour_info import BroadcastTourCreateResponse200TourInfo





T = TypeVar("T", bound="BroadcastTourCreateResponse200Tour")



@_attrs_define
class BroadcastTourCreateResponse200Tour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastTourCreateResponse200TourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastTourCreateResponse200TourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastTourCreateResponse200TourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastTourCreateResponse200TourInfo.from_dict(_info)
        ...
        broadcast_tour_create_response_200_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_tour_create_response_200_tour.additional_properties = d
        return broadcast_tour_create_response_200_tour
