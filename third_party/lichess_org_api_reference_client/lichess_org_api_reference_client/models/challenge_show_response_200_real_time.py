...
T = TypeVar("T", bound="ChallengeShowResponse200RealTime")



@_attrs_define
class ChallengeShowResponse200RealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_show_response_200_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_show_response_200_real_time
