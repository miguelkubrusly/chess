...
if TYPE_CHECKING:
  from ..models.broadcast_round_create_response_200_tour_info import BroadcastRoundCreateResponse200TourInfo





T = TypeVar("T", bound="BroadcastRoundCreateResponse200Tour")



@_attrs_define
class BroadcastRoundCreateResponse200Tour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastRoundCreateResponse200TourInfo]): Additional display information about the
                tournament
    ...
    info: Union[Unset, 'BroadcastRoundCreateResponse200TourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastRoundCreateResponse200TourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastRoundCreateResponse200TourInfo.from_dict(_info)
        ...
        broadcast_round_create_response_200_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_create_response_200_tour.additional_properties = d
        return broadcast_round_create_response_200_tour
