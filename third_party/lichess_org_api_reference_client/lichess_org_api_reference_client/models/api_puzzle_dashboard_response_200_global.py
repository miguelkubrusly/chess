...
T = TypeVar("T", bound="ApiPuzzleDashboardResponse200Global")



@_attrs_define
class ApiPuzzleDashboardResponse200Global:
    """ 
        Attributes:
            first_wins (int):
            nb (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_puzzle_dashboard_response_200_global = cls(
        ...
        api_puzzle_dashboard_response_200_global.additional_properties = d
        return api_puzzle_dashboard_response_200_global
