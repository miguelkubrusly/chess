...
T = TypeVar("T", bound="UserActivityGamesBlitzRp")



@_attrs_define
class UserActivityGamesBlitzRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_blitz_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_blitz_rp.additional_properties = d
        return user_activity_games_blitz_rp
