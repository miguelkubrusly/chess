...
T = TypeVar("T", bound="ArenaTournamentsFinishedItemThematic")



@_attrs_define
class ArenaTournamentsFinishedItemThematic:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_finished_item_thematic = cls(
            eco=eco,
            name=name,
            fen=fen,
            url=url,
        ...
        arena_tournaments_finished_item_thematic.additional_properties = d
        return arena_tournaments_finished_item_thematic
