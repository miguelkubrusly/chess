...
T = TypeVar("T", bound="ChallengeEventChallengeCorrespondence")



@_attrs_define
class ChallengeEventChallengeCorrespondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_event_challenge_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_event_challenge_correspondence
