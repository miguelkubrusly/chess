...
from ..models.game_user_user_title import GameUserUserTitle
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="GameUserUser")
...
class GameUserUser:
    """ 
        Attributes:
            ...
            title (Union[Unset, GameUserUserTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, GameUserUserTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, GameUserUserTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = GameUserUserTitle(_title)
        ...
        game_user_user.additional_properties = d
        return game_user_user
