...
if TYPE_CHECKING:
  from ..models.game_json_players_black_analysis import GameJsonPlayersBlackAnalysis
  from ..models.game_json_players_black_user import GameJsonPlayersBlackUser





T = TypeVar("T", bound="GameJsonPlayersBlack")



@_attrs_define
class GameJsonPlayersBlack:
    """ 
        Attributes:
            user (GameJsonPlayersBlackUser):
            rating (int):
            rating_diff (Union[Unset, int]):
            name (Union[Unset, str]):
            provisional (Union[Unset, bool]):
            ai_level (Union[Unset, int]):
            analysis (Union[Unset, GameJsonPlayersBlackAnalysis]):
    ...
    analysis: Union[Unset, 'GameJsonPlayersBlackAnalysis'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.game_json_players_black_user import GameJsonPlayersBlackUser
        d = dict(src_dict)
        user = GameJsonPlayersBlackUser.from_dict(d.pop("user"))
        ...
        if isinstance(_analysis,  Unset):
            ...
            analysis = GameJsonPlayersBlackAnalysis.from_dict(_analysis)
        ...
        game_json_players_black.additional_properties = d
        return game_json_players_black
