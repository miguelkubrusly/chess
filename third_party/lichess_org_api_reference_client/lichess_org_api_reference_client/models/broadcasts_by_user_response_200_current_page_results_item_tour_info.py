...
from ..models.broadcasts_by_user_response_200_current_page_results_item_tour_info_fide_tc import BroadcastsByUserResponse200CurrentPageResultsItemTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastsByUserResponse200CurrentPageResultsItemTourInfo")



@_attrs_define
class BroadcastsByUserResponse200CurrentPageResultsItemTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastsByUserResponse200CurrentPageResultsItemTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastsByUserResponse200CurrentPageResultsItemTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastsByUserResponse200CurrentPageResultsItemTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastsByUserResponse200CurrentPageResultsItemTourInfoFideTc(_fide_tc)
        ...
        broadcasts_by_user_response_200_current_page_results_item_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcasts_by_user_response_200_current_page_results_item_tour_info.additional_properties = d
        return broadcasts_by_user_response_200_current_page_results_item_tour_info
