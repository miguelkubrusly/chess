...
T = TypeVar("T", bound="PuzzleRaceResultsPlayersItem")



@_attrs_define
class PuzzleRaceResultsPlayersItem:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        puzzle_race_results_players_item = cls(
            name=name,
            score=score,
            id=id,
            flair=flair,
        ...
        puzzle_race_results_players_item.additional_properties = d
        return puzzle_race_results_players_item
