...
T = TypeVar("T", bound="UserExtendedPerfsRapid")



@_attrs_define
class UserExtendedPerfsRapid:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_rapid.additional_properties = d
        return user_extended_perfs_rapid
