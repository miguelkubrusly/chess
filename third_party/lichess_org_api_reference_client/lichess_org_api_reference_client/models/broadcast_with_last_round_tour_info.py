...
from ..models.broadcast_with_last_round_tour_info_fide_tc import BroadcastWithLastRoundTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastWithLastRoundTourInfo")



@_attrs_define
class BroadcastWithLastRoundTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastWithLastRoundTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastWithLastRoundTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastWithLastRoundTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastWithLastRoundTourInfoFideTc(_fide_tc)
        ...
        broadcast_with_last_round_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_with_last_round_tour_info.additional_properties = d
        return broadcast_with_last_round_tour_info
