...
T = TypeVar("T", bound="TournamentResponse200FeaturedC")



@_attrs_define
class TournamentResponse200FeaturedC:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tournament_response_200_featured_c = cls(
            white=white,
            black=black,
        )


        tournament_response_200_featured_c.additional_properties = d
        return tournament_response_200_featured_c
