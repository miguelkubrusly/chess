...
T = TypeVar("T", bound="ChallengeOpenResponse200Correspondence")



@_attrs_define
class ChallengeOpenResponse200Correspondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_open_response_200_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_open_response_200_correspondence
