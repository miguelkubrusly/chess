...
T = TypeVar("T", bound="ApiTournamentResponse200StartedItemCustomPosition")



@_attrs_define
class ApiTournamentResponse200StartedItemCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_tournament_response_200_started_item_custom_position = cls(
            name=name,
            fen=fen,
        )


        api_tournament_response_200_started_item_custom_position.additional_properties = d
        return api_tournament_response_200_started_item_custom_position
