...
from ..models.broadcast_form_info_fide_tc import BroadcastFormInfoFideTc
from ..models.broadcast_form_tiebreaks_item import BroadcastFormTiebreaksItem
from ..models.broadcast_form_tier import BroadcastFormTier
from ..models.broadcast_form_visibility import BroadcastFormVisibility
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastForm")
...
class BroadcastForm:
    """ 
        Attributes:
            ...
            info_fide_tc (Union[Unset, BroadcastFormInfoFideTc]): FIDE rating category. Which FIDE ratings to use
            ...
            team_table (Union[Unset, bool]): Show a team leaderboard. Requires WhiteTeam and BlackTeam PGN tags.
                 Default: False.
            visibility (Union[Unset, BroadcastFormVisibility]): Who can view the broadcast.
                ...
                * `private`: Only the broadcast owner(s) can view the broadcast
                 Default: BroadcastFormVisibility.PUBLIC.
            ...
            tier (Union[Unset, BroadcastFormTier]): Optional, for Lichess admins only, used to feature on /broadcast.

                * `3` for Official: normal tier
                * `4` for Official: high tier
                * `5` for Official: best tier
            tiebreaks (Union[Unset, list[BroadcastFormTiebreaksItem]]):
     """
    ...
    info_fide_tc: Union[Unset, BroadcastFormInfoFideTc] = UNSET
    ...
    visibility: Union[Unset, BroadcastFormVisibility] = BroadcastFormVisibility.PUBLIC
    players: Union[Unset, str] = UNSET
    teams: Union[Unset, str] = UNSET
    tier: Union[Unset, BroadcastFormTier] = UNSET
    tiebreaks: Union[Unset, list[BroadcastFormTiebreaksItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info_fide_tc: Union[Unset, BroadcastFormInfoFideTc]
        if isinstance(_info_fide_tc,  Unset):
            info_fide_tc = UNSET
        else:
            info_fide_tc = BroadcastFormInfoFideTc(_info_fide_tc)
        ...
        visibility: Union[Unset, BroadcastFormVisibility]
        if isinstance(_visibility,  Unset):
            visibility = UNSET
        else:
            visibility = BroadcastFormVisibility(_visibility)
        ...
        tier: Union[Unset, BroadcastFormTier]
        if isinstance(_tier,  Unset):
            tier = UNSET
        else:
            tier = BroadcastFormTier(_tier)
        ...
        for tiebreaks_item_data in (_tiebreaks or []):
            tiebreaks_item = BroadcastFormTiebreaksItem(tiebreaks_item_data)
        ...
        broadcast_form.additional_properties = d
        return broadcast_form
