...
T = TypeVar("T", bound="ChallengeOpenJsonCorrespondence")



@_attrs_define
class ChallengeOpenJsonCorrespondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_open_json_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_open_json_correspondence
