...
from ..models.external_engine_registration_variants_item import ExternalEngineRegistrationVariantsItem
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ExternalEngineRegistration")



@_attrs_define
class ExternalEngineRegistration:
    """ 
        Attributes:
            ...
            variants (Union[Unset, list[ExternalEngineRegistrationVariantsItem]]): Optional list of supported chess
                variants.
    ...
    max_hash: int
    provider_secret: str
    variants: Union[Unset, list[ExternalEngineRegistrationVariantsItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in (_variants or []):
            variants_item = ExternalEngineRegistrationVariantsItem(variants_item_data)
        ...
        external_engine_registration = cls(
            name=name,
        ...
        external_engine_registration.additional_properties = d
        return external_engine_registration
