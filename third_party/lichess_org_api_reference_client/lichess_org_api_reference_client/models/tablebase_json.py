...
from ..models.tablebase_json_category import TablebaseJsonCategory
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.tablebase_json_moves_item import TablebaseJsonMovesItem





T = TypeVar("T", bound="TablebaseJson")
...
class TablebaseJson:
    """ 
        ...
        Attributes:
            category (Union[Unset, TablebaseJsonCategory]): `cursed-win` and `blessed-loss` means the 50-move rule prevents
                the decisive result.
            ...
            moves (Union[Unset, list['TablebaseJsonMovesItem']]): Information about legal moves, best first
     """

    category: Union[Unset, TablebaseJsonCategory] = UNSET
    ...
    moves: Union[Unset, list['TablebaseJsonMovesItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Union[Unset, TablebaseJsonCategory]
        if isinstance(_category,  Unset):
            category = UNSET
        else:
            category = TablebaseJsonCategory(_category)
        ...
        for moves_item_data in (_moves or []):
            moves_item = TablebaseJsonMovesItem.from_dict(moves_item_data)
        ...
        tablebase_json.additional_properties = d
        return tablebase_json
