...
T = TypeVar("T", bound="PuzzleDashboardThemesAdditionalPropertyResults")



@_attrs_define
class PuzzleDashboardThemesAdditionalPropertyResults:
    """ 
        Attributes:
            first_wins (int):
            nb (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        puzzle_dashboard_themes_additional_property_results = cls(
        ...
        puzzle_dashboard_themes_additional_property_results.additional_properties = d
        return puzzle_dashboard_themes_additional_property_results
