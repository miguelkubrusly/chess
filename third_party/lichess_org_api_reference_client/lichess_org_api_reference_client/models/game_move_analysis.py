...
if TYPE_CHECKING:
  from ..models.game_move_analysis_judgment import GameMoveAnalysisJudgment





T = TypeVar("T", bound="GameMoveAnalysis")
...
class GameMoveAnalysis:
    """ 
        Attributes:
            ...
            judgment (Union[Unset, GameMoveAnalysisJudgment]): Judgment annotation (only if played move was inaccurate)
     """
    ...
    judgment: Union[Unset, 'GameMoveAnalysisJudgment'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        judgment: Union[Unset, GameMoveAnalysisJudgment]
        if isinstance(_judgment,  Unset):
            judgment = UNSET
        else:
            judgment = GameMoveAnalysisJudgment.from_dict(_judgment)




        game_move_analysis = cls(
            eval_=eval_,
            mate=mate,
            best=best,
            variation=variation,
        ...
        game_move_analysis.additional_properties = d
