...
T = TypeVar("T", bound="ChallengeCanceledEventChallengeRealTime")



@_attrs_define
class ChallengeCanceledEventChallengeRealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_canceled_event_challenge_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_canceled_event_challenge_real_time
