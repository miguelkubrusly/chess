...
from ..models.challenge_json_dest_user_type_0_title_type_0 import ChallengeJsonDestUserType0TitleType0
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ChallengeJsonDestUserType0")



@_attrs_define
class ChallengeJsonDestUserType0:
    """ 
        Attributes:
            id (str):
            name (str):
            rating (Union[Unset, float]):
            title (Union[ChallengeJsonDestUserType0TitleType0, None, Unset]):
    ...
    title: Union[ChallengeJsonDestUserType0TitleType0, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.title, Unset):
            title = UNSET
        elif isinstance(self.title, ChallengeJsonDestUserType0TitleType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_title(data: object) -> Union[ChallengeJsonDestUserType0TitleType0, None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                title_type_0 = ChallengeJsonDestUserType0TitleType0(data)
                ...
                pass
            return cast(Union[ChallengeJsonDestUserType0TitleType0, None, Unset], data)
        ...
        challenge_json_dest_user_type_0 = cls(
            id=id,
            name=name,
            rating=rating,
            title=title,
        ...
        challenge_json_dest_user_type_0.additional_properties = d
        return challenge_json_dest_user_type_0
