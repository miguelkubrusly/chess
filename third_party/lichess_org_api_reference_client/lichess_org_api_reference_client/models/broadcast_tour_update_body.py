...
from ..models.broadcast_tour_update_body_info_fide_tc import BroadcastTourUpdateBodyInfoFideTc
from ..models.broadcast_tour_update_body_tiebreaks_item import BroadcastTourUpdateBodyTiebreaksItem
from ..models.broadcast_tour_update_body_tier import BroadcastTourUpdateBodyTier
from ..models.broadcast_tour_update_body_visibility import BroadcastTourUpdateBodyVisibility
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTourUpdateBody")



@_attrs_define
class BroadcastTourUpdateBody:
    """ 
        Attributes:
            ...
            info_fide_tc (Union[Unset, BroadcastTourUpdateBodyInfoFideTc]): FIDE rating category. Which FIDE ratings to use
            ...
            team_table (Union[Unset, bool]): Show a team leaderboard. Requires WhiteTeam and BlackTeam PGN tags.
                 Default: False.
            visibility (Union[Unset, BroadcastTourUpdateBodyVisibility]): Who can view the broadcast.
                ...
                * `private`: Only the broadcast owner(s) can view the broadcast
                 Default: BroadcastTourUpdateBodyVisibility.PUBLIC.
            ...
            tier (Union[Unset, BroadcastTourUpdateBodyTier]): Optional, for Lichess admins only, used to feature on
                /broadcast.

                * `3` for Official: normal tier
                * `4` for Official: high tier
                * `5` for Official: best tier
            tiebreaks (Union[Unset, list[BroadcastTourUpdateBodyTiebreaksItem]]):
     """
    ...
    info_fide_tc: Union[Unset, BroadcastTourUpdateBodyInfoFideTc] = UNSET
    ...
    visibility: Union[Unset, BroadcastTourUpdateBodyVisibility] = BroadcastTourUpdateBodyVisibility.PUBLIC
    players: Union[Unset, str] = UNSET
    teams: Union[Unset, str] = UNSET
    tier: Union[Unset, BroadcastTourUpdateBodyTier] = UNSET
    tiebreaks: Union[Unset, list[BroadcastTourUpdateBodyTiebreaksItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info_fide_tc: Union[Unset, BroadcastTourUpdateBodyInfoFideTc]
        if isinstance(_info_fide_tc,  Unset):
            info_fide_tc = UNSET
        else:
            info_fide_tc = BroadcastTourUpdateBodyInfoFideTc(_info_fide_tc)
        ...
        visibility: Union[Unset, BroadcastTourUpdateBodyVisibility]
        if isinstance(_visibility,  Unset):
            visibility = UNSET
        else:
            visibility = BroadcastTourUpdateBodyVisibility(_visibility)
        ...
        tier: Union[Unset, BroadcastTourUpdateBodyTier]
        if isinstance(_tier,  Unset):
            tier = UNSET
        else:
            tier = BroadcastTourUpdateBodyTier(_tier)
        ...
        for tiebreaks_item_data in (_tiebreaks or []):
            tiebreaks_item = BroadcastTourUpdateBodyTiebreaksItem(tiebreaks_item_data)
        ...
        broadcast_tour_update_body = cls(
            name=name,
        ...
        broadcast_tour_update_body.additional_properties = d
        return broadcast_tour_update_body
