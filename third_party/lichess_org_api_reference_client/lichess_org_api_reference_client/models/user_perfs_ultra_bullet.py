...
T = TypeVar("T", bound="UserPerfsUltraBullet")



@_attrs_define
class UserPerfsUltraBullet:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_ultra_bullet.additional_properties = d
        return user_perfs_ultra_bullet
