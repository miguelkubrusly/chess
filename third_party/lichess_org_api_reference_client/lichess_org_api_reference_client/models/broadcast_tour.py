...
if TYPE_CHECKING:
  from ..models.broadcast_tour_info import BroadcastTourInfo





T = TypeVar("T", bound="BroadcastTour")
...
class BroadcastTour:
    """ 
        Attributes:
            ...
            info (Union[Unset, BroadcastTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastTourInfo.from_dict(_info)
        ...
        broadcast_tour.additional_properties = d
        return broadcast_tour
