...
if TYPE_CHECKING:
  from ..models.team_all_response_200_current_page_results_item import TeamAllResponse200CurrentPageResultsItem





T = TypeVar("T", bound="TeamAllResponse200")



@_attrs_define
class TeamAllResponse200:
    """ 
        Attributes:
            current_page (float):  Example: 4.
            max_per_page (float):  Example: 15.
            current_page_results (list['TeamAllResponse200CurrentPageResultsItem']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for current_page_results_item_data in (_current_page_results):
            current_page_results_item = TeamAllResponse200CurrentPageResultsItem.from_dict(current_page_results_item_data)
        ...
        team_all_response_200.additional_properties = d
        return team_all_response_200
