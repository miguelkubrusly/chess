...
from ..models.api_simul_response_200_pending_item_host_title import ApiSimulResponse200PendingItemHostTitle
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiSimulResponse200PendingItemHost")



@_attrs_define
class ApiSimulResponse200PendingItemHost:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            title (Union[Unset, ApiSimulResponse200PendingItemHostTitle]): only appears if the user is a titled player or a
                bot user
    ...
    title: Union[Unset, ApiSimulResponse200PendingItemHostTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, ApiSimulResponse200PendingItemHostTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = ApiSimulResponse200PendingItemHostTitle(_title)
        ...
        api_simul_response_200_pending_item_host = cls(
            id=id,
            name=name,
            flair=flair,
            title=title,
        ...
        api_simul_response_200_pending_item_host.additional_properties = d
        return api_simul_response_200_pending_item_host
