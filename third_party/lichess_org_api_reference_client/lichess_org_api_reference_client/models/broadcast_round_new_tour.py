...
if TYPE_CHECKING:
  from ..models.broadcast_round_new_tour_info import BroadcastRoundNewTourInfo





T = TypeVar("T", bound="BroadcastRoundNewTour")



@_attrs_define
class BroadcastRoundNewTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastRoundNewTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastRoundNewTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastRoundNewTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastRoundNewTourInfo.from_dict(_info)
        ...
        broadcast_round_new_tour.additional_properties = d
        return broadcast_round_new_tour
