...
T = TypeVar("T", bound="UserExtendedPerfsClassical")



@_attrs_define
class UserExtendedPerfsClassical:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_classical = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_classical.additional_properties = d
        return user_extended_perfs_classical
