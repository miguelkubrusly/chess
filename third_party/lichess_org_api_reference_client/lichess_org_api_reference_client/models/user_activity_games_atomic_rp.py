...
T = TypeVar("T", bound="UserActivityGamesAtomicRp")



@_attrs_define
class UserActivityGamesAtomicRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_atomic_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_atomic_rp.additional_properties = d
        return user_activity_games_atomic_rp
