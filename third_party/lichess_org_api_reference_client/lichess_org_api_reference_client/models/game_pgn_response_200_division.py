...
T = TypeVar("T", bound="GamePgnResponse200Division")



@_attrs_define
class GamePgnResponse200Division:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_pgn_response_200_division = cls(
            middle=middle,
            end=end,
        )


        game_pgn_response_200_division.additional_properties = d
        return game_pgn_response_200_division
