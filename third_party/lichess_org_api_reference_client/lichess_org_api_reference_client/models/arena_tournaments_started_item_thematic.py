...
T = TypeVar("T", bound="ArenaTournamentsStartedItemThematic")



@_attrs_define
class ArenaTournamentsStartedItemThematic:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_started_item_thematic = cls(
            eco=eco,
            name=name,
            fen=fen,
            url=url,
        ...
        arena_tournaments_started_item_thematic.additional_properties = d
        return arena_tournaments_started_item_thematic
