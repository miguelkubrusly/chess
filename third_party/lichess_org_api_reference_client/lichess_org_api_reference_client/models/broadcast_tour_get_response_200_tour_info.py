...
from ..models.broadcast_tour_get_response_200_tour_info_fide_tc import BroadcastTourGetResponse200TourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTourGetResponse200TourInfo")



@_attrs_define
class BroadcastTourGetResponse200TourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTourGetResponse200TourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTourGetResponse200TourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTourGetResponse200TourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTourGetResponse200TourInfoFideTc(_fide_tc)
        ...
        broadcast_tour_get_response_200_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_tour_get_response_200_tour_info.additional_properties = d
        return broadcast_tour_get_response_200_tour_info
