...
T = TypeVar("T", bound="ChallengeOpenResponse200Unlimited")



@_attrs_define
class ChallengeOpenResponse200Unlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_open_response_200_unlimited = cls(
            type_=type_,
        )

        return challenge_open_response_200_unlimited
