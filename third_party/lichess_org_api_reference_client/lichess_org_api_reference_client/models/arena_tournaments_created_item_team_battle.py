...
T = TypeVar("T", bound="ArenaTournamentsCreatedItemTeamBattle")



@_attrs_define
class ArenaTournamentsCreatedItemTeamBattle:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_created_item_team_battle = cls(
            teams=teams,
            nb_leaders=nb_leaders,
        )


        arena_tournaments_created_item_team_battle.additional_properties = d
        return arena_tournaments_created_item_team_battle
