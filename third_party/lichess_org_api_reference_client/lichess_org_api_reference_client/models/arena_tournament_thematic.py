...
T = TypeVar("T", bound="ArenaTournamentThematic")



@_attrs_define
class ArenaTournamentThematic:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournament_thematic.additional_properties = d
        return arena_tournament_thematic
