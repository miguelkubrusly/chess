...
T = TypeVar("T", bound="ChallengeListResponse200OutItemRealTime")



@_attrs_define
class ChallengeListResponse200OutItemRealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_list_response_200_out_item_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_list_response_200_out_item_real_time
