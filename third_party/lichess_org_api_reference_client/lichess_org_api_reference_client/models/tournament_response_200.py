...
if TYPE_CHECKING:
  from ..models.tournament_response_200_min_rating import TournamentResponse200MinRating
  from ..models.tournament_response_200_featured import TournamentResponse200Featured
  from ..models.tournament_response_200_clock import TournamentResponse200Clock
  from ..models.tournament_response_200_podium_item import TournamentResponse200PodiumItem
  from ..models.tournament_response_200_min_rated_games import TournamentResponse200MinRatedGames
  from ..models.tournament_response_200_quote import TournamentResponse200Quote
  from ..models.tournament_response_200_standing import TournamentResponse200Standing
  from ..models.tournament_response_200_duels_item import TournamentResponse200DuelsItem
  from ..models.tournament_response_200_spotlight import TournamentResponse200Spotlight
  from ..models.tournament_response_200_verdicts import TournamentResponse200Verdicts
  from ..models.tournament_response_200_max_rating import TournamentResponse200MaxRating
  from ..models.tournament_response_200_perf import TournamentResponse200Perf
  from ..models.tournament_response_200_schedule import TournamentResponse200Schedule
  from ..models.tournament_response_200_stats import TournamentResponse200Stats
  from ..models.tournament_response_200_great_player import TournamentResponse200GreatPlayer





T = TypeVar("T", bound="TournamentResponse200")



@_attrs_define
class TournamentResponse200:
    """ 
        Attributes:
            id (str):
            full_name (str):
            clock (TournamentResponse200Clock):
            nb_players (float):
            rated (Union[Unset, bool]):
            spotlight (Union[Unset, TournamentResponse200Spotlight]):
            ...
            verdicts (Union[Unset, TournamentResponse200Verdicts]):
            quote (Union[Unset, TournamentResponse200Quote]): The quote displayed on the tournament page
            great_player (Union[Unset, TournamentResponse200GreatPlayer]):
            allow_list (Union[Unset, list[str]]): List of usernames allowed to join the tournament
            has_max_rating (Union[Unset, bool]):
            max_rating (Union[Unset, TournamentResponse200MaxRating]):
            min_rating (Union[Unset, TournamentResponse200MinRating]):
            min_rated_games (Union[Unset, TournamentResponse200MinRatedGames]):
            bots_allowed (Union[Unset, bool]):
            min_account_age_in_days (Union[Unset, int]):
            perf (Union[Unset, TournamentResponse200Perf]):
            schedule (Union[Unset, TournamentResponse200Schedule]):
            description (Union[Unset, str]):
            variant (Union[Unset, str]):
            duels (Union[Unset, list['TournamentResponse200DuelsItem']]):
            standing (Union[Unset, TournamentResponse200Standing]):
            featured (Union[Unset, TournamentResponse200Featured]):
            podium (Union[Unset, list['TournamentResponse200PodiumItem']]):
            stats (Union[Unset, TournamentResponse200Stats]):
    ...
    spotlight: Union[Unset, 'TournamentResponse200Spotlight'] = UNSET
    ...
    verdicts: Union[Unset, 'TournamentResponse200Verdicts'] = UNSET
    quote: Union[Unset, 'TournamentResponse200Quote'] = UNSET
    great_player: Union[Unset, 'TournamentResponse200GreatPlayer'] = UNSET
    allow_list: Union[Unset, list[str]] = UNSET
    has_max_rating: Union[Unset, bool] = UNSET
    max_rating: Union[Unset, 'TournamentResponse200MaxRating'] = UNSET
    min_rating: Union[Unset, 'TournamentResponse200MinRating'] = UNSET
    min_rated_games: Union[Unset, 'TournamentResponse200MinRatedGames'] = UNSET
    bots_allowed: Union[Unset, bool] = UNSET
    min_account_age_in_days: Union[Unset, int] = UNSET
    perf: Union[Unset, 'TournamentResponse200Perf'] = UNSET
    schedule: Union[Unset, 'TournamentResponse200Schedule'] = UNSET
    description: Union[Unset, str] = UNSET
    variant: Union[Unset, str] = UNSET
    duels: Union[Unset, list['TournamentResponse200DuelsItem']] = UNSET
    standing: Union[Unset, 'TournamentResponse200Standing'] = UNSET
    featured: Union[Unset, 'TournamentResponse200Featured'] = UNSET
    podium: Union[Unset, list['TournamentResponse200PodiumItem']] = UNSET
    stats: Union[Unset, 'TournamentResponse200Stats'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clock = TournamentResponse200Clock.from_dict(d.pop("clock"))
        ...
        if isinstance(_spotlight,  Unset):
            ...
            spotlight = TournamentResponse200Spotlight.from_dict(_spotlight)
        ...
        if isinstance(_verdicts,  Unset):
            ...
            verdicts = TournamentResponse200Verdicts.from_dict(_verdicts)




        _quote = d.pop("quote", UNSET)
        quote: Union[Unset, TournamentResponse200Quote]
        if isinstance(_quote,  Unset):
            quote = UNSET
        else:
            quote = TournamentResponse200Quote.from_dict(_quote)
        ...
        if isinstance(_great_player,  Unset):
            ...
            great_player = TournamentResponse200GreatPlayer.from_dict(_great_player)
        ...
        if isinstance(_max_rating,  Unset):
            ...
            max_rating = TournamentResponse200MaxRating.from_dict(_max_rating)
        ...
        if isinstance(_min_rating,  Unset):
            ...
            min_rating = TournamentResponse200MinRating.from_dict(_min_rating)
        ...
        if isinstance(_min_rated_games,  Unset):
            ...
            min_rated_games = TournamentResponse200MinRatedGames.from_dict(_min_rated_games)
        ...
        if isinstance(_perf,  Unset):
            ...
            perf = TournamentResponse200Perf.from_dict(_perf)
        ...
        if isinstance(_schedule,  Unset):
            ...
            schedule = TournamentResponse200Schedule.from_dict(_schedule)
        ...
        for duels_item_data in (_duels or []):
            duels_item = TournamentResponse200DuelsItem.from_dict(duels_item_data)
        ...
        if isinstance(_standing,  Unset):
            ...
            standing = TournamentResponse200Standing.from_dict(_standing)
        ...
        if isinstance(_featured,  Unset):
            ...
            featured = TournamentResponse200Featured.from_dict(_featured)
        ...
        for podium_item_data in (_podium or []):
            podium_item = TournamentResponse200PodiumItem.from_dict(podium_item_data)
        ...
        if isinstance(_stats,  Unset):
            ...
            stats = TournamentResponse200Stats.from_dict(_stats)
        ...
        tournament_response_200.additional_properties = d
        return tournament_response_200
