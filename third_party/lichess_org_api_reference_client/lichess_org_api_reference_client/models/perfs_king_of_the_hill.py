...
T = TypeVar("T", bound="PerfsKingOfTheHill")



@_attrs_define
class PerfsKingOfTheHill:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        perfs_king_of_the_hill.additional_properties = d
        return perfs_king_of_the_hill
