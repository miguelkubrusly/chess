...
if TYPE_CHECKING:
  from ..models.game_json_analysis_item_judgment import GameJsonAnalysisItemJudgment





T = TypeVar("T", bound="GameJsonAnalysisItem")



@_attrs_define
class GameJsonAnalysisItem:
    """ 
        Attributes:
            ...
            judgment (Union[Unset, GameJsonAnalysisItemJudgment]): Judgment annotation (only if played move was inaccurate)
     """
    ...
    judgment: Union[Unset, 'GameJsonAnalysisItemJudgment'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        judgment: Union[Unset, GameJsonAnalysisItemJudgment]
        if isinstance(_judgment,  Unset):
            judgment = UNSET
        else:
            judgment = GameJsonAnalysisItemJudgment.from_dict(_judgment)




        game_json_analysis_item = cls(
            eval_=eval_,
            mate=mate,
            best=best,
            variation=variation,
        ...
        game_json_analysis_item.additional_properties = d
        return game_json_analysis_item
