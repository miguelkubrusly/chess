...
from ..models.broadcast_my_round_tour_info_fide_tc import BroadcastMyRoundTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastMyRoundTourInfo")



@_attrs_define
class BroadcastMyRoundTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastMyRoundTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastMyRoundTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastMyRoundTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastMyRoundTourInfoFideTc(_fide_tc)
        ...
        broadcast_my_round_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_my_round_tour_info.additional_properties = d
        return broadcast_my_round_tour_info
