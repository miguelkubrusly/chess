...
from ..models.broadcast_tour_info_fide_tc import BroadcastTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTourInfo")



@_attrs_define
class BroadcastTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTourInfoFideTc(_fide_tc)
        ...
        broadcast_tour_info.additional_properties = d
        return broadcast_tour_info
