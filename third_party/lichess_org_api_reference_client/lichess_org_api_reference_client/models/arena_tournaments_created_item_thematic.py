...
T = TypeVar("T", bound="ArenaTournamentsCreatedItemThematic")



@_attrs_define
class ArenaTournamentsCreatedItemThematic:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_created_item_thematic = cls(
            eco=eco,
            name=name,
            fen=fen,
            url=url,
        ...
        arena_tournaments_created_item_thematic.additional_properties = d
        return arena_tournaments_created_item_thematic
