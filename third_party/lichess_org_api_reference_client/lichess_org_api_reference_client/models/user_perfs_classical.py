...
T = TypeVar("T", bound="UserPerfsClassical")



@_attrs_define
class UserPerfsClassical:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_classical.additional_properties = d
        return user_perfs_classical
