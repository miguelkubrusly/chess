...
T = TypeVar("T", bound="UserExtendedPerfsBlitz")



@_attrs_define
class UserExtendedPerfsBlitz:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_blitz.additional_properties = d
        return user_extended_perfs_blitz
