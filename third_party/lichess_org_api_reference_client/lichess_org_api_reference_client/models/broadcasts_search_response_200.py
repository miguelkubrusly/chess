...
if TYPE_CHECKING:
  from ..models.broadcasts_search_response_200_current_page_results_item import BroadcastsSearchResponse200CurrentPageResultsItem





T = TypeVar("T", bound="BroadcastsSearchResponse200")



@_attrs_define
class BroadcastsSearchResponse200:
    """ 
        Attributes:
            current_page (float):
            max_per_page (float):
            current_page_results (list['BroadcastsSearchResponse200CurrentPageResultsItem']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for current_page_results_item_data in (_current_page_results):
            current_page_results_item = BroadcastsSearchResponse200CurrentPageResultsItem.from_dict(current_page_results_item_data)
        ...
        broadcasts_search_response_200 = cls(
        ...
        broadcasts_search_response_200.additional_properties = d
        return broadcasts_search_response_200
