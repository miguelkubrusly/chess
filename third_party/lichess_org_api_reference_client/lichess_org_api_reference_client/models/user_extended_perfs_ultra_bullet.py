...
T = TypeVar("T", bound="UserExtendedPerfsUltraBullet")



@_attrs_define
class UserExtendedPerfsUltraBullet:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_ultra_bullet = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_ultra_bullet.additional_properties = d
        return user_extended_perfs_ultra_bullet
