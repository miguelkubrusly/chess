...
T = TypeVar("T", bound="ArenaTournamentsFinishedItemCustomPosition")



@_attrs_define
class ArenaTournamentsFinishedItemCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_finished_item_custom_position = cls(
            name=name,
            fen=fen,
        )


        arena_tournaments_finished_item_custom_position.additional_properties = d
        return arena_tournaments_finished_item_custom_position
