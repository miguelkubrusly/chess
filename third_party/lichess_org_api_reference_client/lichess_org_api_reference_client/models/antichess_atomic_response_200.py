...
from ..models.antichess_atomic_response_200_category import AntichessAtomicResponse200Category
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.antichess_atomic_response_200_moves_item import AntichessAtomicResponse200MovesItem





T = TypeVar("T", bound="AntichessAtomicResponse200")



@_attrs_define
class AntichessAtomicResponse200:
    """ 
        Example:
        ...
        Attributes:
            category (Union[Unset, AntichessAtomicResponse200Category]): `cursed-win` and `blessed-loss` means the 50-move
                rule prevents
                the decisive result.
            ...
            moves (Union[Unset, list['AntichessAtomicResponse200MovesItem']]): Information about legal moves, best first
     """

    category: Union[Unset, AntichessAtomicResponse200Category] = UNSET
    ...
    moves: Union[Unset, list['AntichessAtomicResponse200MovesItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Union[Unset, AntichessAtomicResponse200Category]
        if isinstance(_category,  Unset):
            category = UNSET
        else:
            category = AntichessAtomicResponse200Category(_category)
        ...
        for moves_item_data in (_moves or []):
            moves_item = AntichessAtomicResponse200MovesItem.from_dict(moves_item_data)
        ...
        antichess_atomic_response_200 = cls(
            category=category,
            dtz=dtz,
        ...
        antichess_atomic_response_200.additional_properties = d
        return antichess_atomic_response_200
