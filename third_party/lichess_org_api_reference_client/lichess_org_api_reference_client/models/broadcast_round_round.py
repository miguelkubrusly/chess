...
if TYPE_CHECKING:
  from ..models.broadcast_round_round_custom_scoring import BroadcastRoundRoundCustomScoring





T = TypeVar("T", bound="BroadcastRoundRound")



@_attrs_define
class BroadcastRoundRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_round_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_round.additional_properties = d
        return broadcast_round_round
