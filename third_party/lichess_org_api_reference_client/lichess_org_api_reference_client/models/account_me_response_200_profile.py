...
T = TypeVar("T", bound="AccountMeResponse200Profile")



@_attrs_define
class AccountMeResponse200Profile:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_me_response_200_profile = cls(
            flag=flag,
            location=location,
            bio=bio,
            real_name=real_name,
        ...
        account_me_response_200_profile.additional_properties = d
        return account_me_response_200_profile
