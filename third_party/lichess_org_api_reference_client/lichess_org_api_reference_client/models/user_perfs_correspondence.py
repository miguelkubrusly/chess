...
T = TypeVar("T", bound="UserPerfsCorrespondence")



@_attrs_define
class UserPerfsCorrespondence:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_correspondence.additional_properties = d
        return user_perfs_correspondence
