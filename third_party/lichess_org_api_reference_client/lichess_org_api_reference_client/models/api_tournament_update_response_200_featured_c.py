...
T = TypeVar("T", bound="ApiTournamentUpdateResponse200FeaturedC")



@_attrs_define
class ApiTournamentUpdateResponse200FeaturedC:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_tournament_update_response_200_featured_c = cls(
            white=white,
            black=black,
        )


        api_tournament_update_response_200_featured_c.additional_properties = d
        return api_tournament_update_response_200_featured_c
