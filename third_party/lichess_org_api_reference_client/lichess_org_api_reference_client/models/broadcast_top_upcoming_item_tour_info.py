...
from ..models.broadcast_top_upcoming_item_tour_info_fide_tc import BroadcastTopUpcomingItemTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTopUpcomingItemTourInfo")



@_attrs_define
class BroadcastTopUpcomingItemTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTopUpcomingItemTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTopUpcomingItemTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTopUpcomingItemTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTopUpcomingItemTourInfoFideTc(_fide_tc)
        ...
        broadcast_top_upcoming_item_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_top_upcoming_item_tour_info.additional_properties = d
        return broadcast_top_upcoming_item_tour_info
