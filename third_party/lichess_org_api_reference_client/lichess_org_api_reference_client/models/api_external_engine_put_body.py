...
from ..models.api_external_engine_put_body_variants_item import ApiExternalEnginePutBodyVariantsItem
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiExternalEnginePutBody")



@_attrs_define
class ApiExternalEnginePutBody:
    """ 
        Attributes:
            ...
            variants (Union[Unset, list[ApiExternalEnginePutBodyVariantsItem]]): Optional list of supported chess variants.
    ...
    max_hash: int
    provider_secret: str
    variants: Union[Unset, list[ApiExternalEnginePutBodyVariantsItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in (_variants or []):
            variants_item = ApiExternalEnginePutBodyVariantsItem(variants_item_data)
        ...
        api_external_engine_put_body = cls(
            name=name,
        ...
        api_external_engine_put_body.additional_properties = d
        return api_external_engine_put_body
