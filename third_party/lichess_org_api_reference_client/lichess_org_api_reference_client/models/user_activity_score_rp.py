...
T = TypeVar("T", bound="UserActivityScoreRp")



@_attrs_define
class UserActivityScoreRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_score_rp = cls(
            before=before,
            after=after,
        )


        user_activity_score_rp.additional_properties = d
        return user_activity_score_rp
