...
if TYPE_CHECKING:
  from ..models.broadcasts_top_response_200_upcoming_item_tour_info import BroadcastsTopResponse200UpcomingItemTourInfo





T = TypeVar("T", bound="BroadcastsTopResponse200UpcomingItemTour")



@_attrs_define
class BroadcastsTopResponse200UpcomingItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastsTopResponse200UpcomingItemTourInfo]): Additional display information about the
                tournament
    ...
    info: Union[Unset, 'BroadcastsTopResponse200UpcomingItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastsTopResponse200UpcomingItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastsTopResponse200UpcomingItemTourInfo.from_dict(_info)
        ...
        broadcasts_top_response_200_upcoming_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_top_response_200_upcoming_item_tour.additional_properties = d
        return broadcasts_top_response_200_upcoming_item_tour
