...
if TYPE_CHECKING:
  from ..models.broadcasts_search_response_200_current_page_results_item_tour_info import BroadcastsSearchResponse200CurrentPageResultsItemTourInfo





T = TypeVar("T", bound="BroadcastsSearchResponse200CurrentPageResultsItemTour")



@_attrs_define
class BroadcastsSearchResponse200CurrentPageResultsItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastsSearchResponse200CurrentPageResultsItemTourInfo]): Additional display information
    ...
    info: Union[Unset, 'BroadcastsSearchResponse200CurrentPageResultsItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastsSearchResponse200CurrentPageResultsItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastsSearchResponse200CurrentPageResultsItemTourInfo.from_dict(_info)
        ...
        broadcasts_search_response_200_current_page_results_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_search_response_200_current_page_results_item_tour.additional_properties = d
        return broadcasts_search_response_200_current_page_results_item_tour
