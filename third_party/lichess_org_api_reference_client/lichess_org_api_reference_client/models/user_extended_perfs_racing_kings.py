...
T = TypeVar("T", bound="UserExtendedPerfsRacingKings")



@_attrs_define
class UserExtendedPerfsRacingKings:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_racing_kings = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_racing_kings.additional_properties = d
        return user_extended_perfs_racing_kings
