...
if TYPE_CHECKING:
  from ..models.broadcasts_top_response_200_past_current_page_results_item_round_custom_scoring import BroadcastsTopResponse200PastCurrentPageResultsItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastsTopResponse200PastCurrentPageResultsItemRound")



@_attrs_define
class BroadcastsTopResponse200PastCurrentPageResultsItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemRoundCustomScoring]): Scoring
                overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastsTopResponse200PastCurrentPageResultsItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastsTopResponse200PastCurrentPageResultsItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcasts_top_response_200_past_current_page_results_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_top_response_200_past_current_page_results_item_round.additional_properties = d
        return broadcasts_top_response_200_past_current_page_results_item_round
