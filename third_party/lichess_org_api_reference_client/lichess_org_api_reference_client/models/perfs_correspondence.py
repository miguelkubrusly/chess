...
T = TypeVar("T", bound="PerfsCorrespondence")



@_attrs_define
class PerfsCorrespondence:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        perfs_correspondence.additional_properties = d
        return perfs_correspondence
