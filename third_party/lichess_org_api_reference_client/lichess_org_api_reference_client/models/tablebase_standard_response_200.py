...
from ..models.tablebase_standard_response_200_category import TablebaseStandardResponse200Category
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.tablebase_standard_response_200_moves_item import TablebaseStandardResponse200MovesItem





T = TypeVar("T", bound="TablebaseStandardResponse200")



@_attrs_define
class TablebaseStandardResponse200:
    """ 
        Example:
        ...
        Attributes:
            category (Union[Unset, TablebaseStandardResponse200Category]): `cursed-win` and `blessed-loss` means the 50-move
                rule prevents
                the decisive result.
            ...
            moves (Union[Unset, list['TablebaseStandardResponse200MovesItem']]): Information about legal moves, best first
     """

    category: Union[Unset, TablebaseStandardResponse200Category] = UNSET
    ...
    moves: Union[Unset, list['TablebaseStandardResponse200MovesItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category: Union[Unset, TablebaseStandardResponse200Category]
        if isinstance(_category,  Unset):
            category = UNSET
        else:
            category = TablebaseStandardResponse200Category(_category)
        ...
        for moves_item_data in (_moves or []):
            moves_item = TablebaseStandardResponse200MovesItem.from_dict(moves_item_data)
        ...
        tablebase_standard_response_200 = cls(
            category=category,
            dtz=dtz,
        ...
        tablebase_standard_response_200.additional_properties = d
        return tablebase_standard_response_200
