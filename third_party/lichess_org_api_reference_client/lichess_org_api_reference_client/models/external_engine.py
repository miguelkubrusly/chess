...
from ..models.external_engine_variants_item import ExternalEngineVariantsItem
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ExternalEngine")
...
class ExternalEngine:
    """ 
        Attributes:
            ...
            variants (list[ExternalEngineVariantsItem]): List of supported chess variants.
    ...
    max_threads: int
    max_hash: int
    variants: list[ExternalEngineVariantsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in (_variants):
            variants_item = ExternalEngineVariantsItem(variants_item_data)
        ...
        external_engine.additional_properties = d
