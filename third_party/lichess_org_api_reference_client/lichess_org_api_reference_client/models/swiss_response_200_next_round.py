...
T = TypeVar("T", bound="SwissResponse200NextRound")



@_attrs_define
class SwissResponse200NextRound:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        swiss_response_200_next_round = cls(
            at=at,
            in_=in_,
        )


        swiss_response_200_next_round.additional_properties = d
        return swiss_response_200_next_round
