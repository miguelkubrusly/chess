...
T = TypeVar("T", bound="UserExtendedPerfsAntichess")



@_attrs_define
class UserExtendedPerfsAntichess:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_antichess = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_antichess.additional_properties = d
        return user_extended_perfs_antichess
