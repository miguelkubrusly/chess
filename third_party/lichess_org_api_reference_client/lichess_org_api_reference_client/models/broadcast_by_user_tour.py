...
if TYPE_CHECKING:
  from ..models.broadcast_by_user_tour_info import BroadcastByUserTourInfo





T = TypeVar("T", bound="BroadcastByUserTour")



@_attrs_define
class BroadcastByUserTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastByUserTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastByUserTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastByUserTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastByUserTourInfo.from_dict(_info)
        ...
        broadcast_by_user_tour.additional_properties = d
        return broadcast_by_user_tour
