...
if TYPE_CHECKING:
  from ..models.broadcast_top_past_current_page_results_item_round_custom_scoring import BroadcastTopPastCurrentPageResultsItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastTopPastCurrentPageResultsItemRound")



@_attrs_define
class BroadcastTopPastCurrentPageResultsItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastTopPastCurrentPageResultsItemRoundCustomScoring]): Scoring overrides for
                wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastTopPastCurrentPageResultsItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastTopPastCurrentPageResultsItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastTopPastCurrentPageResultsItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_top_past_current_page_results_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_top_past_current_page_results_item_round.additional_properties = d
        return broadcast_top_past_current_page_results_item_round
