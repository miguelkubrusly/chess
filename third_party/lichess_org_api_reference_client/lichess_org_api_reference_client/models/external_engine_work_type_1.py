...
from ..models.external_engine_work_type_1_variant import ExternalEngineWorkType1Variant
...
T = TypeVar("T", bound="ExternalEngineWorkType1")



@_attrs_define
class ExternalEngineWorkType1:
    """ 
        Attributes:
            ...
            variant (ExternalEngineWorkType1Variant):  Default: ExternalEngineWorkType1Variant.CHESS. Example: chess.
    ...
    initial_fen: str
    moves: list[str]
    variant: ExternalEngineWorkType1Variant = ExternalEngineWorkType1Variant.CHESS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variant = ExternalEngineWorkType1Variant(d.pop("variant"))
        ...
        external_engine_work_type_1 = cls(
            depth=depth,
        ...
        external_engine_work_type_1.additional_properties = d
        return external_engine_work_type_1
