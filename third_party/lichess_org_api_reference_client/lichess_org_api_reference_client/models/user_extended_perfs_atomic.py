...
T = TypeVar("T", bound="UserExtendedPerfsAtomic")



@_attrs_define
class UserExtendedPerfsAtomic:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_atomic = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_atomic.additional_properties = d
        return user_extended_perfs_atomic
