...
from ..models.fide_player_search_response_200_item_title import FidePlayerSearchResponse200ItemTitle
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="FidePlayerSearchResponse200Item")



@_attrs_define
class FidePlayerSearchResponse200Item:
    """ 
        Attributes:
            id (int):
            name (str):
            federation (str):
            title (Union[Unset, FidePlayerSearchResponse200ItemTitle]): only appears if the user is a titled player or a bot
                user
    ...
    name: str
    federation: str
    title: Union[Unset, FidePlayerSearchResponse200ItemTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, FidePlayerSearchResponse200ItemTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = FidePlayerSearchResponse200ItemTitle(_title)
        ...
        fide_player_search_response_200_item = cls(
            id=id,
            name=name,
            federation=federation,
            title=title,
        ...
        fide_player_search_response_200_item.additional_properties = d
        return fide_player_search_response_200_item
