...
T = TypeVar("T", bound="BulkPairingGamesItem")



@_attrs_define
class BulkPairingGamesItem:
    """ 
        Attributes:
            id (Union[Unset, str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_pairing_games_item.additional_properties = d
        return bulk_pairing_games_item
