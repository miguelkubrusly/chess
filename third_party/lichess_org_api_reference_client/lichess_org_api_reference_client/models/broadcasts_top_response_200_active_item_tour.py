...
if TYPE_CHECKING:
  from ..models.broadcasts_top_response_200_active_item_tour_info import BroadcastsTopResponse200ActiveItemTourInfo





T = TypeVar("T", bound="BroadcastsTopResponse200ActiveItemTour")



@_attrs_define
class BroadcastsTopResponse200ActiveItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastsTopResponse200ActiveItemTourInfo]): Additional display information about the
                tournament
    ...
    info: Union[Unset, 'BroadcastsTopResponse200ActiveItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastsTopResponse200ActiveItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastsTopResponse200ActiveItemTourInfo.from_dict(_info)
        ...
        broadcasts_top_response_200_active_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_top_response_200_active_item_tour.additional_properties = d
        return broadcasts_top_response_200_active_item_tour
