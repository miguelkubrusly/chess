...
T = TypeVar("T", bound="ChallengeShowResponse200Unlimited")



@_attrs_define
class ChallengeShowResponse200Unlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_show_response_200_unlimited = cls(
            type_=type_,
        )

        return challenge_show_response_200_unlimited
