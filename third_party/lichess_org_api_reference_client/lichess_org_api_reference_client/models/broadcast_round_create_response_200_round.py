...
if TYPE_CHECKING:
  from ..models.broadcast_round_create_response_200_round_custom_scoring import BroadcastRoundCreateResponse200RoundCustomScoring





T = TypeVar("T", bound="BroadcastRoundCreateResponse200Round")



@_attrs_define
class BroadcastRoundCreateResponse200Round:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundCreateResponse200RoundCustomScoring]): Scoring overrides for wins or
                draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundCreateResponse200RoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundCreateResponse200RoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundCreateResponse200RoundCustomScoring.from_dict(_custom_scoring)




        broadcast_round_create_response_200_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_create_response_200_round.additional_properties = d
        return broadcast_round_create_response_200_round
