...
from ..models.broadcast_round_update_response_200_tour_info_fide_tc import BroadcastRoundUpdateResponse200TourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastRoundUpdateResponse200TourInfo")



@_attrs_define
class BroadcastRoundUpdateResponse200TourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastRoundUpdateResponse200TourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastRoundUpdateResponse200TourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastRoundUpdateResponse200TourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastRoundUpdateResponse200TourInfoFideTc(_fide_tc)
        ...
        broadcast_round_update_response_200_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_round_update_response_200_tour_info.additional_properties = d
        return broadcast_round_update_response_200_tour_info
