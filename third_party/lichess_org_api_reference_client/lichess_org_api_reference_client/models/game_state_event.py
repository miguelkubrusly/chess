...
from ..models.game_state_event_status import GameStateEventStatus
from ..models.game_state_event_winner import GameStateEventWinner
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="GameStateEvent")
...
class GameStateEvent:
    """ 
        ...
        Attributes:
            ...
            status (GameStateEventStatus):
            winner (Union[Unset, GameStateEventWinner]): Color of the winner, if any
    ...
    binc: int
    status: GameStateEventStatus
    winner: Union[Unset, GameStateEventWinner] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GameStateEventStatus(d.pop("status"))




        _winner = d.pop("winner", UNSET)
        winner: Union[Unset, GameStateEventWinner]
        if isinstance(_winner,  Unset):
            winner = UNSET
        else:
            winner = GameStateEventWinner(_winner)
        ...
        game_state_event.additional_properties = d
