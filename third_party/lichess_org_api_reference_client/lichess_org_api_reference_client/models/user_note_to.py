...
from ..models.user_note_to_title import UserNoteToTitle
from ..types import UNSET, Unset
...
class UserNoteTo:
    """ 
        Attributes:
            ...
            title (Union[Unset, UserNoteToTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, UserNoteToTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, UserNoteToTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = UserNoteToTitle(_title)
        ...
        user_note_to.additional_properties = d
        return user_note_to
