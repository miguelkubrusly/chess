...
if TYPE_CHECKING:
  from ..models.broadcasts_search_response_200_current_page_results_item_round_custom_scoring import BroadcastsSearchResponse200CurrentPageResultsItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastsSearchResponse200CurrentPageResultsItemRound")



@_attrs_define
class BroadcastsSearchResponse200CurrentPageResultsItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastsSearchResponse200CurrentPageResultsItemRoundCustomScoring]): Scoring
    ...
    custom_scoring: Union[Unset, 'BroadcastsSearchResponse200CurrentPageResultsItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastsSearchResponse200CurrentPageResultsItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastsSearchResponse200CurrentPageResultsItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcasts_search_response_200_current_page_results_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_search_response_200_current_page_results_item_round.additional_properties = d
        return broadcasts_search_response_200_current_page_results_item_round
