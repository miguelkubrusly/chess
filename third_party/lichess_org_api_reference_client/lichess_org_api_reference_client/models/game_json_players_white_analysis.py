...
T = TypeVar("T", bound="GameJsonPlayersWhiteAnalysis")



@_attrs_define
class GameJsonPlayersWhiteAnalysis:
    """ 
        Attributes:
            inaccuracy (float):
            mistake (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_json_players_white_analysis = cls(
            inaccuracy=inaccuracy,
            mistake=mistake,
            blunder=blunder,
            acpl=acpl,
        ...
        game_json_players_white_analysis.additional_properties = d
        return game_json_players_white_analysis
