...
from ..models.api_external_engine_list_response_200_item_variants_item import ApiExternalEngineListResponse200ItemVariantsItem
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiExternalEngineListResponse200Item")



@_attrs_define
class ApiExternalEngineListResponse200Item:
    """ 
        Attributes:
            ...
            variants (list[ApiExternalEngineListResponse200ItemVariantsItem]): List of supported chess variants.
    ...
    max_threads: int
    max_hash: int
    variants: list[ApiExternalEngineListResponse200ItemVariantsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in (_variants):
            variants_item = ApiExternalEngineListResponse200ItemVariantsItem(variants_item_data)
        ...
        api_external_engine_list_response_200_item = cls(
            id=id,
            name=name,
        ...
        api_external_engine_list_response_200_item.additional_properties = d
        return api_external_engine_list_response_200_item
