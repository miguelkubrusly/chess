...
if TYPE_CHECKING:
  from ..models.api_tournament_update_response_200_min_rated_games import ApiTournamentUpdateResponse200MinRatedGames
  from ..models.api_tournament_update_response_200_featured import ApiTournamentUpdateResponse200Featured
  from ..models.api_tournament_update_response_200_verdicts import ApiTournamentUpdateResponse200Verdicts
  from ..models.api_tournament_update_response_200_spotlight import ApiTournamentUpdateResponse200Spotlight
  from ..models.api_tournament_update_response_200_podium_item import ApiTournamentUpdateResponse200PodiumItem
  from ..models.api_tournament_update_response_200_min_rating import ApiTournamentUpdateResponse200MinRating
  from ..models.api_tournament_update_response_200_great_player import ApiTournamentUpdateResponse200GreatPlayer
  from ..models.api_tournament_update_response_200_standing import ApiTournamentUpdateResponse200Standing
  from ..models.api_tournament_update_response_200_perf import ApiTournamentUpdateResponse200Perf
  from ..models.api_tournament_update_response_200_schedule import ApiTournamentUpdateResponse200Schedule
  from ..models.api_tournament_update_response_200_max_rating import ApiTournamentUpdateResponse200MaxRating
  from ..models.api_tournament_update_response_200_stats import ApiTournamentUpdateResponse200Stats
  from ..models.api_tournament_update_response_200_duels_item import ApiTournamentUpdateResponse200DuelsItem
  from ..models.api_tournament_update_response_200_clock import ApiTournamentUpdateResponse200Clock
  from ..models.api_tournament_update_response_200_quote import ApiTournamentUpdateResponse200Quote





T = TypeVar("T", bound="ApiTournamentUpdateResponse200")



@_attrs_define
class ApiTournamentUpdateResponse200:
    """ 
        Attributes:
            id (str):
            full_name (str):
            clock (ApiTournamentUpdateResponse200Clock):
            nb_players (float):
            rated (Union[Unset, bool]):
            spotlight (Union[Unset, ApiTournamentUpdateResponse200Spotlight]):
            ...
            verdicts (Union[Unset, ApiTournamentUpdateResponse200Verdicts]):
            quote (Union[Unset, ApiTournamentUpdateResponse200Quote]): The quote displayed on the tournament page
            great_player (Union[Unset, ApiTournamentUpdateResponse200GreatPlayer]):
            allow_list (Union[Unset, list[str]]): List of usernames allowed to join the tournament
            has_max_rating (Union[Unset, bool]):
            max_rating (Union[Unset, ApiTournamentUpdateResponse200MaxRating]):
            min_rating (Union[Unset, ApiTournamentUpdateResponse200MinRating]):
            min_rated_games (Union[Unset, ApiTournamentUpdateResponse200MinRatedGames]):
            bots_allowed (Union[Unset, bool]):
            min_account_age_in_days (Union[Unset, int]):
            perf (Union[Unset, ApiTournamentUpdateResponse200Perf]):
            schedule (Union[Unset, ApiTournamentUpdateResponse200Schedule]):
            description (Union[Unset, str]):
            variant (Union[Unset, str]):
            duels (Union[Unset, list['ApiTournamentUpdateResponse200DuelsItem']]):
            standing (Union[Unset, ApiTournamentUpdateResponse200Standing]):
            featured (Union[Unset, ApiTournamentUpdateResponse200Featured]):
            podium (Union[Unset, list['ApiTournamentUpdateResponse200PodiumItem']]):
            stats (Union[Unset, ApiTournamentUpdateResponse200Stats]):
    ...
    spotlight: Union[Unset, 'ApiTournamentUpdateResponse200Spotlight'] = UNSET
    ...
    verdicts: Union[Unset, 'ApiTournamentUpdateResponse200Verdicts'] = UNSET
    quote: Union[Unset, 'ApiTournamentUpdateResponse200Quote'] = UNSET
    great_player: Union[Unset, 'ApiTournamentUpdateResponse200GreatPlayer'] = UNSET
    allow_list: Union[Unset, list[str]] = UNSET
    has_max_rating: Union[Unset, bool] = UNSET
    max_rating: Union[Unset, 'ApiTournamentUpdateResponse200MaxRating'] = UNSET
    min_rating: Union[Unset, 'ApiTournamentUpdateResponse200MinRating'] = UNSET
    min_rated_games: Union[Unset, 'ApiTournamentUpdateResponse200MinRatedGames'] = UNSET
    bots_allowed: Union[Unset, bool] = UNSET
    min_account_age_in_days: Union[Unset, int] = UNSET
    perf: Union[Unset, 'ApiTournamentUpdateResponse200Perf'] = UNSET
    schedule: Union[Unset, 'ApiTournamentUpdateResponse200Schedule'] = UNSET
    description: Union[Unset, str] = UNSET
    variant: Union[Unset, str] = UNSET
    duels: Union[Unset, list['ApiTournamentUpdateResponse200DuelsItem']] = UNSET
    standing: Union[Unset, 'ApiTournamentUpdateResponse200Standing'] = UNSET
    featured: Union[Unset, 'ApiTournamentUpdateResponse200Featured'] = UNSET
    podium: Union[Unset, list['ApiTournamentUpdateResponse200PodiumItem']] = UNSET
    stats: Union[Unset, 'ApiTournamentUpdateResponse200Stats'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clock = ApiTournamentUpdateResponse200Clock.from_dict(d.pop("clock"))
        ...
        if isinstance(_spotlight,  Unset):
            ...
            spotlight = ApiTournamentUpdateResponse200Spotlight.from_dict(_spotlight)
        ...
        if isinstance(_verdicts,  Unset):
            ...
            verdicts = ApiTournamentUpdateResponse200Verdicts.from_dict(_verdicts)




        _quote = d.pop("quote", UNSET)
        quote: Union[Unset, ApiTournamentUpdateResponse200Quote]
        if isinstance(_quote,  Unset):
            quote = UNSET
        else:
            quote = ApiTournamentUpdateResponse200Quote.from_dict(_quote)
        ...
        if isinstance(_great_player,  Unset):
            ...
            great_player = ApiTournamentUpdateResponse200GreatPlayer.from_dict(_great_player)
        ...
        if isinstance(_max_rating,  Unset):
            ...
            max_rating = ApiTournamentUpdateResponse200MaxRating.from_dict(_max_rating)
        ...
        if isinstance(_min_rating,  Unset):
            ...
            min_rating = ApiTournamentUpdateResponse200MinRating.from_dict(_min_rating)
        ...
        if isinstance(_min_rated_games,  Unset):
            ...
            min_rated_games = ApiTournamentUpdateResponse200MinRatedGames.from_dict(_min_rated_games)
        ...
        if isinstance(_perf,  Unset):
            ...
            perf = ApiTournamentUpdateResponse200Perf.from_dict(_perf)
        ...
        if isinstance(_schedule,  Unset):
            ...
            schedule = ApiTournamentUpdateResponse200Schedule.from_dict(_schedule)
        ...
        for duels_item_data in (_duels or []):
            duels_item = ApiTournamentUpdateResponse200DuelsItem.from_dict(duels_item_data)
        ...
        if isinstance(_standing,  Unset):
            ...
            standing = ApiTournamentUpdateResponse200Standing.from_dict(_standing)
        ...
        if isinstance(_featured,  Unset):
            ...
            featured = ApiTournamentUpdateResponse200Featured.from_dict(_featured)
        ...
        for podium_item_data in (_podium or []):
            podium_item = ApiTournamentUpdateResponse200PodiumItem.from_dict(podium_item_data)
        ...
        if isinstance(_stats,  Unset):
            ...
            stats = ApiTournamentUpdateResponse200Stats.from_dict(_stats)
        ...
        api_tournament_update_response_200 = cls(
            id=id,
            full_name=full_name,
            clock=clock,
        ...
        api_tournament_update_response_200.additional_properties = d
        return api_tournament_update_response_200
