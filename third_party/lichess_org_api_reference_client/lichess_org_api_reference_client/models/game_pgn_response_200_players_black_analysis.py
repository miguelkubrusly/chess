...
T = TypeVar("T", bound="GamePgnResponse200PlayersBlackAnalysis")



@_attrs_define
class GamePgnResponse200PlayersBlackAnalysis:
    """ 
        Attributes:
            inaccuracy (float):
            mistake (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_pgn_response_200_players_black_analysis = cls(
            inaccuracy=inaccuracy,
            mistake=mistake,
            blunder=blunder,
            acpl=acpl,
        ...
        game_pgn_response_200_players_black_analysis.additional_properties = d
        return game_pgn_response_200_players_black_analysis
