...
if TYPE_CHECKING:
  from ..models.broadcast_round_update_response_200_round_custom_scoring import BroadcastRoundUpdateResponse200RoundCustomScoring





T = TypeVar("T", bound="BroadcastRoundUpdateResponse200Round")



@_attrs_define
class BroadcastRoundUpdateResponse200Round:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundUpdateResponse200RoundCustomScoring]): Scoring overrides for wins or
                draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundUpdateResponse200RoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundUpdateResponse200RoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundUpdateResponse200RoundCustomScoring.from_dict(_custom_scoring)




        broadcast_round_update_response_200_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_update_response_200_round.additional_properties = d
        return broadcast_round_update_response_200_round
