...
if TYPE_CHECKING:
  from ..models.broadcast_round_tour_info import BroadcastRoundTourInfo





T = TypeVar("T", bound="BroadcastRoundTour")



@_attrs_define
class BroadcastRoundTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastRoundTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastRoundTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastRoundTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastRoundTourInfo.from_dict(_info)
        ...
        broadcast_round_tour.additional_properties = d
        return broadcast_round_tour
