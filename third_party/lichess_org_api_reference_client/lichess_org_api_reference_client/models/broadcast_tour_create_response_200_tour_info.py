...
from ..models.broadcast_tour_create_response_200_tour_info_fide_tc import BroadcastTourCreateResponse200TourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTourCreateResponse200TourInfo")



@_attrs_define
class BroadcastTourCreateResponse200TourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTourCreateResponse200TourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTourCreateResponse200TourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTourCreateResponse200TourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTourCreateResponse200TourInfoFideTc(_fide_tc)
        ...
        broadcast_tour_create_response_200_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_tour_create_response_200_tour_info.additional_properties = d
        return broadcast_tour_create_response_200_tour_info
