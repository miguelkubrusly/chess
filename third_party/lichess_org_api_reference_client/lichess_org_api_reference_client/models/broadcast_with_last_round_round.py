...
if TYPE_CHECKING:
  from ..models.broadcast_with_last_round_round_custom_scoring import BroadcastWithLastRoundRoundCustomScoring





T = TypeVar("T", bound="BroadcastWithLastRoundRound")



@_attrs_define
class BroadcastWithLastRoundRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastWithLastRoundRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastWithLastRoundRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastWithLastRoundRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastWithLastRoundRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_with_last_round_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_with_last_round_round.additional_properties = d
        return broadcast_with_last_round_round
