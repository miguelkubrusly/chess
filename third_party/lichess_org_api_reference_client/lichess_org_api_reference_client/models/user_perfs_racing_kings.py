...
T = TypeVar("T", bound="UserPerfsRacingKings")



@_attrs_define
class UserPerfsRacingKings:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_racing_kings.additional_properties = d
        return user_perfs_racing_kings
