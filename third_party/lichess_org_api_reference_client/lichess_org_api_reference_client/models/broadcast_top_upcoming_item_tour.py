...
if TYPE_CHECKING:
  from ..models.broadcast_top_upcoming_item_tour_info import BroadcastTopUpcomingItemTourInfo





T = TypeVar("T", bound="BroadcastTopUpcomingItemTour")



@_attrs_define
class BroadcastTopUpcomingItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastTopUpcomingItemTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastTopUpcomingItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastTopUpcomingItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastTopUpcomingItemTourInfo.from_dict(_info)
        ...
        broadcast_top_upcoming_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_top_upcoming_item_tour.additional_properties = d
        return broadcast_top_upcoming_item_tour
