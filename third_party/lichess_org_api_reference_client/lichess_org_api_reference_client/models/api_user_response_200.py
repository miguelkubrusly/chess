...
from ..models.api_user_response_200_title import ApiUserResponse200Title
from ..types import UNSET, Unset
from typing import cast
from typing import Union

if TYPE_CHECKING:
  from ..models.api_user_response_200_profile import ApiUserResponse200Profile
  from ..models.api_user_response_200_count import ApiUserResponse200Count
  from ..models.api_user_response_200_play_time import ApiUserResponse200PlayTime
  from ..models.api_user_response_200_streamer import ApiUserResponse200Streamer
  from ..models.api_user_response_200_perfs import ApiUserResponse200Perfs





T = TypeVar("T", bound="ApiUserResponse200")



@_attrs_define
class ApiUserResponse200:
    """ 
        Attributes:
            id (str):  Example: georges.
            username (str):  Example: Georges.
            url (str):  Example: https://lichess.org/@/georges.
            perfs (Union[Unset, ApiUserResponse200Perfs]):
            title (Union[Unset, ApiUserResponse200Title]): only appears if the user is a titled player or a bot user
            ...
            profile (Union[Unset, ApiUserResponse200Profile]):
            seen_at (Union[Unset, int]):  Example: 1522636452014.
            play_time (Union[Unset, ApiUserResponse200PlayTime]):
            ...
            count (Union[Unset, ApiUserResponse200Count]):
            streaming (Union[Unset, bool]):
            streamer (Union[Unset, ApiUserResponse200Streamer]):
    ...
    username: str
    url: str
    perfs: Union[Unset, 'ApiUserResponse200Perfs'] = UNSET
    title: Union[Unset, ApiUserResponse200Title] = UNSET
    flair: Union[Unset, str] = UNSET
    created_at: Union[Unset, int] = UNSET
    disabled: Union[Unset, bool] = UNSET
    tos_violation: Union[Unset, bool] = UNSET
    profile: Union[Unset, 'ApiUserResponse200Profile'] = UNSET
    seen_at: Union[Unset, int] = UNSET
    play_time: Union[Unset, 'ApiUserResponse200PlayTime'] = UNSET
    patron: Union[Unset, bool] = UNSET
    verified: Union[Unset, bool] = UNSET
    playing: Union[Unset, str] = UNSET
    count: Union[Unset, 'ApiUserResponse200Count'] = UNSET
    streaming: Union[Unset, bool] = UNSET
    streamer: Union[Unset, 'ApiUserResponse200Streamer'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_perfs,  Unset):
            ...
            perfs = ApiUserResponse200Perfs.from_dict(_perfs)




        _title = d.pop("title", UNSET)
        title: Union[Unset, ApiUserResponse200Title]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = ApiUserResponse200Title(_title)
        ...
        if isinstance(_profile,  Unset):
            ...
            profile = ApiUserResponse200Profile.from_dict(_profile)
        ...
        if isinstance(_play_time,  Unset):
            ...
            play_time = ApiUserResponse200PlayTime.from_dict(_play_time)
        ...
        if isinstance(_count,  Unset):
            ...
            count = ApiUserResponse200Count.from_dict(_count)
        ...
        if isinstance(_streamer,  Unset):
            ...
            streamer = ApiUserResponse200Streamer.from_dict(_streamer)
        ...
        api_user_response_200.additional_properties = d
        return api_user_response_200
