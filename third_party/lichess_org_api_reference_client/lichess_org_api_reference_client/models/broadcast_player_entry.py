...
from ..models.broadcast_player_entry_title import BroadcastPlayerEntryTitle
from ..types import UNSET, Unset
from typing import cast
from typing import Union

if TYPE_CHECKING:
  from ..models.broadcast_player_entry_tiebreaks_item import BroadcastPlayerEntryTiebreaksItem





T = TypeVar("T", bound="BroadcastPlayerEntry")



@_attrs_define
class BroadcastPlayerEntry:
    """ 
        Attributes:
            ...
            title (Union[Unset, BroadcastPlayerEntryTitle]): only appears if the user is a titled player or a bot user
                Example: FM.
            fide_id (Union[Unset, int]):  Example: 3408230.
            fed (Union[Unset, str]):  Example: CHI.
            tiebreaks (Union[Unset, list['BroadcastPlayerEntryTiebreaksItem']]):
    ...
    title: Union[Unset, BroadcastPlayerEntryTitle] = UNSET
    fide_id: Union[Unset, int] = UNSET
    fed: Union[Unset, str] = UNSET
    tiebreaks: Union[Unset, list['BroadcastPlayerEntryTiebreaksItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, BroadcastPlayerEntryTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = BroadcastPlayerEntryTitle(_title)
        ...
        for tiebreaks_item_data in (_tiebreaks or []):
            tiebreaks_item = BroadcastPlayerEntryTiebreaksItem.from_dict(tiebreaks_item_data)
        ...
        broadcast_player_entry.additional_properties = d
        return broadcast_player_entry
