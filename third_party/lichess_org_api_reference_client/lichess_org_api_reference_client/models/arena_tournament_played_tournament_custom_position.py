...
T = TypeVar("T", bound="ArenaTournamentPlayedTournamentCustomPosition")



@_attrs_define
class ArenaTournamentPlayedTournamentCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournament_played_tournament_custom_position = cls(
            name=name,
            fen=fen,
        )


        arena_tournament_played_tournament_custom_position.additional_properties = d
        return arena_tournament_played_tournament_custom_position
