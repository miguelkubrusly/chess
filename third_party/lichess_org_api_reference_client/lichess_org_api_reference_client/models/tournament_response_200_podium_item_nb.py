...
T = TypeVar("T", bound="TournamentResponse200PodiumItemNb")



@_attrs_define
class TournamentResponse200PodiumItemNb:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tournament_response_200_podium_item_nb = cls(
            game=game,
            berserk=berserk,
            win=win,
        )
        ...
        tournament_response_200_podium_item_nb.additional_properties = d
        return tournament_response_200_podium_item_nb
