...
from ..models.external_engine_work_common_variant import ExternalEngineWorkCommonVariant
...
T = TypeVar("T", bound="ExternalEngineWorkCommon")



@_attrs_define
class ExternalEngineWorkCommon:
    """ 
        Attributes:
            ...
            variant (ExternalEngineWorkCommonVariant):  Default: ExternalEngineWorkCommonVariant.CHESS. Example: chess.
    ...
    initial_fen: str
    moves: list[str]
    variant: ExternalEngineWorkCommonVariant = ExternalEngineWorkCommonVariant.CHESS
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variant = ExternalEngineWorkCommonVariant(d.pop("variant"))
        ...
        external_engine_work_common = cls(
        ...
        external_engine_work_common.additional_properties = d
        return external_engine_work_common
