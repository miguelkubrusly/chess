...
if TYPE_CHECKING:
  from ..models.broadcasts_top_response_200_past_current_page_results_item_tour_info import BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo





T = TypeVar("T", bound="BroadcastsTopResponse200PastCurrentPageResultsItemTour")



@_attrs_define
class BroadcastsTopResponse200PastCurrentPageResultsItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo]): Additional display information
    ...
    info: Union[Unset, 'BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo.from_dict(_info)
        ...
        broadcasts_top_response_200_past_current_page_results_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_top_response_200_past_current_page_results_item_tour.additional_properties = d
        return broadcasts_top_response_200_past_current_page_results_item_tour
