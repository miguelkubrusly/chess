...
if TYPE_CHECKING:
  from ..models.team_paginator_json_current_page_results_item import TeamPaginatorJsonCurrentPageResultsItem





T = TypeVar("T", bound="TeamPaginatorJson")



@_attrs_define
class TeamPaginatorJson:
    """ 
        Attributes:
            current_page (float):  Example: 4.
            max_per_page (float):  Example: 15.
            current_page_results (list['TeamPaginatorJsonCurrentPageResultsItem']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for current_page_results_item_data in (_current_page_results):
            current_page_results_item = TeamPaginatorJsonCurrentPageResultsItem.from_dict(current_page_results_item_data)
        ...
        team_paginator_json.additional_properties = d
        return team_paginator_json
