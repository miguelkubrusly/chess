...
T = TypeVar("T", bound="ChallengeCanceledEventChallengeCorrespondence")



@_attrs_define
class ChallengeCanceledEventChallengeCorrespondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_canceled_event_challenge_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_canceled_event_challenge_correspondence
