...
T = TypeVar("T", bound="UserPerfsAntichess")



@_attrs_define
class UserPerfsAntichess:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_antichess.additional_properties = d
        return user_perfs_antichess
