...
from ..models.tablebase_atomic_response_200_moves_item_category import TablebaseAtomicResponse200MovesItemCategory
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="TablebaseAtomicResponse200MovesItem")



@_attrs_define
class TablebaseAtomicResponse200MovesItem:
    """ 
        Attributes:
            uci (Union[Unset, str]):  Example: h7h8q.
            san (Union[Unset, str]):  Example: h8=Q+.
            category (Union[Unset, TablebaseAtomicResponse200MovesItemCategory]):
    ...
    category: Union[Unset, TablebaseAtomicResponse200MovesItemCategory] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_category,  Unset):
            ...
            category = TablebaseAtomicResponse200MovesItemCategory(_category)
        ...
        tablebase_atomic_response_200_moves_item = cls(
            uci=uci,
            san=san,
            category=category,
            dtz=dtz,
        ...
        tablebase_atomic_response_200_moves_item.additional_properties = d
        return tablebase_atomic_response_200_moves_item
