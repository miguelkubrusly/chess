...
if TYPE_CHECKING:
  from ..models.api_user_current_game_response_200_analysis_item_judgment import ApiUserCurrentGameResponse200AnalysisItemJudgment





T = TypeVar("T", bound="ApiUserCurrentGameResponse200AnalysisItem")



@_attrs_define
class ApiUserCurrentGameResponse200AnalysisItem:
    """ 
        Attributes:
            ...
            judgment (Union[Unset, ApiUserCurrentGameResponse200AnalysisItemJudgment]): Judgment annotation (only if played
                move was inaccurate)
     """
    ...
    judgment: Union[Unset, 'ApiUserCurrentGameResponse200AnalysisItemJudgment'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        judgment: Union[Unset, ApiUserCurrentGameResponse200AnalysisItemJudgment]
        if isinstance(_judgment,  Unset):
            judgment = UNSET
        else:
            judgment = ApiUserCurrentGameResponse200AnalysisItemJudgment.from_dict(_judgment)




        api_user_current_game_response_200_analysis_item = cls(
            eval_=eval_,
            mate=mate,
            best=best,
            variation=variation,
        ...
        api_user_current_game_response_200_analysis_item.additional_properties = d
        return api_user_current_game_response_200_analysis_item
