...
from ..models.bulk_pairing_variant import BulkPairingVariant
from typing import cast
from typing import cast, Union

if TYPE_CHECKING:
  from ..models.bulk_pairing_games_item import BulkPairingGamesItem
  from ..models.bulk_pairing_clock import BulkPairingClock





T = TypeVar("T", bound="BulkPairing")
...
class BulkPairing:
    """ 
        ...
        Attributes:
            id (str):
            games (list['BulkPairingGamesItem']):
            variant (BulkPairingVariant):  Default: BulkPairingVariant.STANDARD. Example: standard.
    ...
    start_clocks_at: int
    scheduled_at: int
    variant: BulkPairingVariant = BulkPairingVariant.STANDARD
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for games_item_data in (_games):
            games_item = BulkPairingGamesItem.from_dict(games_item_data)
        ...
        variant = BulkPairingVariant(d.pop("variant"))




        clock = BulkPairingClock.from_dict(d.pop("clock"))
        ...
        bulk_pairing.additional_properties = d
        return bulk_pairing
