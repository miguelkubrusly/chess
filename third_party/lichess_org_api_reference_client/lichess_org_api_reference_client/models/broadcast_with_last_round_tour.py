...
if TYPE_CHECKING:
  from ..models.broadcast_with_last_round_tour_info import BroadcastWithLastRoundTourInfo





T = TypeVar("T", bound="BroadcastWithLastRoundTour")



@_attrs_define
class BroadcastWithLastRoundTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastWithLastRoundTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastWithLastRoundTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastWithLastRoundTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastWithLastRoundTourInfo.from_dict(_info)
        ...
        broadcast_with_last_round_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_with_last_round_tour.additional_properties = d
        return broadcast_with_last_round_tour
