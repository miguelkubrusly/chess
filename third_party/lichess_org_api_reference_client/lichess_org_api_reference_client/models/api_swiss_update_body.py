...
from ..models.api_swiss_update_body_clock_limit import ApiSwissUpdateBodyClockLimit
from ..models.api_swiss_update_body_conditions_max_rating_rating import ApiSwissUpdateBodyConditionsMaxRatingRating
from ..models.api_swiss_update_body_conditions_min_rating_rating import ApiSwissUpdateBodyConditionsMinRatingRating
from ..models.api_swiss_update_body_round_interval import ApiSwissUpdateBodyRoundInterval
from ..models.api_swiss_update_body_variant import ApiSwissUpdateBodyVariant
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiSwissUpdateBody")



@_attrs_define
class ApiSwissUpdateBody:
    """ 
        Attributes:
            clock_limit (ApiSwissUpdateBodyClockLimit): Clock initial time in seconds Example: 300.
            ...
            round_interval (Union[Unset, ApiSwissUpdateBodyRoundInterval]): How long to wait between each round, in seconds.
                Set to 99999999 to manually schedule each round from the tournament UI, or [with the API](#tag/Swiss-
                tournaments/operation/apiSwissScheduleNextRound).
                If empty or -1, a sensible value is picked automatically.
            variant (Union[Unset, ApiSwissUpdateBodyVariant]):  Default: ApiSwissUpdateBodyVariant.STANDARD. Example:
                standard.
            ...
            chat_for (Union[Unset, float]): Who can read and write in the chat.
                ...
                - 30 = All Lichess players
                 Default: 20.0.
            conditions_min_rating_rating (Union[Unset, ApiSwissUpdateBodyConditionsMinRatingRating]): Minimum rating to
                join. Leave empty to let everyone join the tournament.
            conditions_max_rating_rating (Union[Unset, ApiSwissUpdateBodyConditionsMaxRatingRating]): Maximum rating to
                join. Based on best rating reached in the last 7 days. Leave empty to let everyone join the tournament.
    ...
    clock_limit: ApiSwissUpdateBodyClockLimit
    clock_increment: int
    nb_rounds: int
    name: Union[Unset, str] = UNSET
    starts_at: Union[Unset, int] = UNSET
    round_interval: Union[Unset, ApiSwissUpdateBodyRoundInterval] = UNSET
    variant: Union[Unset, ApiSwissUpdateBodyVariant] = ApiSwissUpdateBodyVariant.STANDARD
    ...
    conditions_min_rating_rating: Union[Unset, ApiSwissUpdateBodyConditionsMinRatingRating] = UNSET
    conditions_max_rating_rating: Union[Unset, ApiSwissUpdateBodyConditionsMaxRatingRating] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        clock_limit = ApiSwissUpdateBodyClockLimit(d.pop("clock.limit"))
        ...
        round_interval: Union[Unset, ApiSwissUpdateBodyRoundInterval]
        if isinstance(_round_interval,  Unset):
            round_interval = UNSET
        else:
            round_interval = ApiSwissUpdateBodyRoundInterval(_round_interval)




        _variant = d.pop("variant", UNSET)
        variant: Union[Unset, ApiSwissUpdateBodyVariant]
        if isinstance(_variant,  Unset):
            variant = UNSET
        else:
            variant = ApiSwissUpdateBodyVariant(_variant)
        ...
        conditions_min_rating_rating: Union[Unset, ApiSwissUpdateBodyConditionsMinRatingRating]
        if isinstance(_conditions_min_rating_rating,  Unset):
            conditions_min_rating_rating = UNSET
        else:
            conditions_min_rating_rating = ApiSwissUpdateBodyConditionsMinRatingRating(_conditions_min_rating_rating)




        _conditions_max_rating_rating = d.pop("conditions.maxRating.rating", UNSET)
        conditions_max_rating_rating: Union[Unset, ApiSwissUpdateBodyConditionsMaxRatingRating]
        if isinstance(_conditions_max_rating_rating,  Unset):
            conditions_max_rating_rating = UNSET
        else:
            conditions_max_rating_rating = ApiSwissUpdateBodyConditionsMaxRatingRating(_conditions_max_rating_rating)
        ...
        api_swiss_update_body.additional_properties = d
        return api_swiss_update_body
