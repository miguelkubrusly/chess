...
T = TypeVar("T", bound="ChallengeListResponse200InItemCorrespondence")



@_attrs_define
class ChallengeListResponse200InItemCorrespondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_list_response_200_in_item_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_list_response_200_in_item_correspondence
