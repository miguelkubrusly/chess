...
T = TypeVar("T", bound="ChallengeCreateResponse200Unlimited")



@_attrs_define
class ChallengeCreateResponse200Unlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_create_response_200_unlimited = cls(
            type_=type_,
        )

        return challenge_create_response_200_unlimited
