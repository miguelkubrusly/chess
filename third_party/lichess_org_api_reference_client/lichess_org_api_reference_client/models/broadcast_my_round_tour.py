...
if TYPE_CHECKING:
  from ..models.broadcast_my_round_tour_info import BroadcastMyRoundTourInfo





T = TypeVar("T", bound="BroadcastMyRoundTour")



@_attrs_define
class BroadcastMyRoundTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastMyRoundTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastMyRoundTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastMyRoundTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastMyRoundTourInfo.from_dict(_info)
        ...
        broadcast_my_round_tour.additional_properties = d
        return broadcast_my_round_tour
