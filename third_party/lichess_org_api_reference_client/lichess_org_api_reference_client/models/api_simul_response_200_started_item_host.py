...
from ..models.api_simul_response_200_started_item_host_title import ApiSimulResponse200StartedItemHostTitle
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiSimulResponse200StartedItemHost")



@_attrs_define
class ApiSimulResponse200StartedItemHost:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            title (Union[Unset, ApiSimulResponse200StartedItemHostTitle]): only appears if the user is a titled player or a
                bot user
    ...
    title: Union[Unset, ApiSimulResponse200StartedItemHostTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, ApiSimulResponse200StartedItemHostTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = ApiSimulResponse200StartedItemHostTitle(_title)
        ...
        api_simul_response_200_started_item_host = cls(
            id=id,
            name=name,
            flair=flair,
            title=title,
        ...
        api_simul_response_200_started_item_host.additional_properties = d
        return api_simul_response_200_started_item_host
