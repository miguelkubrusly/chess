...
if TYPE_CHECKING:
  from ..models.broadcast_round_info_custom_scoring import BroadcastRoundInfoCustomScoring





T = TypeVar("T", bound="BroadcastRoundInfo")



@_attrs_define
class BroadcastRoundInfo:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastRoundInfoCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastRoundInfoCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastRoundInfoCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastRoundInfoCustomScoring.from_dict(_custom_scoring)




        broadcast_round_info = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_info.additional_properties = d
        return broadcast_round_info
