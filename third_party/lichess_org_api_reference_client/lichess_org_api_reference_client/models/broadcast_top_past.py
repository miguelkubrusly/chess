...
if TYPE_CHECKING:
  from ..models.broadcast_top_past_current_page_results_item import BroadcastTopPastCurrentPageResultsItem





T = TypeVar("T", bound="BroadcastTopPast")



@_attrs_define
class BroadcastTopPast:
    """ 
        Attributes:
            current_page (Union[Unset, int]):  Example: 4.
            max_per_page (Union[Unset, int]):  Example: 20.
            current_page_results (Union[Unset, list['BroadcastTopPastCurrentPageResultsItem']]):
    ...
    current_page_results: Union[Unset, list['BroadcastTopPastCurrentPageResultsItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for current_page_results_item_data in (_current_page_results or []):
            current_page_results_item = BroadcastTopPastCurrentPageResultsItem.from_dict(current_page_results_item_data)
        ...
        broadcast_top_past.additional_properties = d
        return broadcast_top_past
