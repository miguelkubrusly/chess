...
from ..models.tablebase_standard_response_200_moves_item_category import TablebaseStandardResponse200MovesItemCategory
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="TablebaseStandardResponse200MovesItem")



@_attrs_define
class TablebaseStandardResponse200MovesItem:
    """ 
        Attributes:
            uci (Union[Unset, str]):  Example: h7h8q.
            san (Union[Unset, str]):  Example: h8=Q+.
            category (Union[Unset, TablebaseStandardResponse200MovesItemCategory]):
    ...
    category: Union[Unset, TablebaseStandardResponse200MovesItemCategory] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_category,  Unset):
            ...
            category = TablebaseStandardResponse200MovesItemCategory(_category)
        ...
        tablebase_standard_response_200_moves_item = cls(
            uci=uci,
            san=san,
            category=category,
            dtz=dtz,
        ...
        tablebase_standard_response_200_moves_item.additional_properties = d
        return tablebase_standard_response_200_moves_item
