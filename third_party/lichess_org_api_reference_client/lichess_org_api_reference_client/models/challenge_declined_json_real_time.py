...
T = TypeVar("T", bound="ChallengeDeclinedJsonRealTime")



@_attrs_define
class ChallengeDeclinedJsonRealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_declined_json_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_declined_json_real_time
