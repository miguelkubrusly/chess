...
T = TypeVar("T", bound="ChallengeCanceledEventChallengeUnlimited")



@_attrs_define
class ChallengeCanceledEventChallengeUnlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_canceled_event_challenge_unlimited = cls(
            type_=type_,
        )

        return challenge_canceled_event_challenge_unlimited
