...
from ..models.challenge_json_challenger_title_type_0 import ChallengeJsonChallengerTitleType0
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ChallengeJsonChallenger")



@_attrs_define
class ChallengeJsonChallenger:
    """ 
        Attributes:
            id (str):
            name (str):
            rating (Union[Unset, float]):
            title (Union[ChallengeJsonChallengerTitleType0, None, Unset]):
    ...
    title: Union[ChallengeJsonChallengerTitleType0, None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.title, Unset):
            title = UNSET
        elif isinstance(self.title, ChallengeJsonChallengerTitleType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_title(data: object) -> Union[ChallengeJsonChallengerTitleType0, None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                title_type_0 = ChallengeJsonChallengerTitleType0(data)
                ...
                pass
            return cast(Union[ChallengeJsonChallengerTitleType0, None, Unset], data)
        ...
        challenge_json_challenger.additional_properties = d
        return challenge_json_challenger
