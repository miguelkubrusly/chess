...
from ..models.account_response_200_prefs_piece_set import AccountResponse200PrefsPieceSet
from ..models.account_response_200_prefs_piece_set_3d import AccountResponse200PrefsPieceSet3D
from ..models.account_response_200_prefs_sound_set import AccountResponse200PrefsSoundSet
from ..models.account_response_200_prefs_theme import AccountResponse200PrefsTheme
from ..models.account_response_200_prefs_theme_3d import AccountResponse200PrefsTheme3D
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="AccountResponse200Prefs")



@_attrs_define
class AccountResponse200Prefs:
    """ 
        Attributes:
            ...
            theme (Union[Unset, AccountResponse200PrefsTheme]):
            piece_set (Union[Unset, AccountResponse200PrefsPieceSet]):
            theme3d (Union[Unset, AccountResponse200PrefsTheme3D]):
            piece_set_3_d (Union[Unset, AccountResponse200PrefsPieceSet3D]):
            sound_set (Union[Unset, AccountResponse200PrefsSoundSet]):
    ...
    theme: Union[Unset, AccountResponse200PrefsTheme] = UNSET
    piece_set: Union[Unset, AccountResponse200PrefsPieceSet] = UNSET
    theme3d: Union[Unset, AccountResponse200PrefsTheme3D] = UNSET
    piece_set_3_d: Union[Unset, AccountResponse200PrefsPieceSet3D] = UNSET
    sound_set: Union[Unset, AccountResponse200PrefsSoundSet] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_theme,  Unset):
            ...
            theme = AccountResponse200PrefsTheme(_theme)
        ...
        if isinstance(_piece_set,  Unset):
            ...
            piece_set = AccountResponse200PrefsPieceSet(_piece_set)
        ...
        if isinstance(_theme3d,  Unset):
            ...
            theme3d = AccountResponse200PrefsTheme3D(_theme3d)
        ...
        if isinstance(_piece_set_3_d,  Unset):
            ...
            piece_set_3_d = AccountResponse200PrefsPieceSet3D(_piece_set_3_d)
        ...
        if isinstance(_sound_set,  Unset):
            ...
            sound_set = AccountResponse200PrefsSoundSet(_sound_set)
        ...
        account_response_200_prefs = cls(
            dark=dark,
            transp=transp,
            bg_img=bg_img,
            is3d=is3d,
        ...
        account_response_200_prefs.additional_properties = d
        return account_response_200_prefs
