...
T = TypeVar("T", bound="ArenaTournamentPlayedTournamentTeamBattle")



@_attrs_define
class ArenaTournamentPlayedTournamentTeamBattle:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournament_played_tournament_team_battle = cls(
            teams=teams,
            nb_leaders=nb_leaders,
        )


        arena_tournament_played_tournament_team_battle.additional_properties = d
        return arena_tournament_played_tournament_team_battle
