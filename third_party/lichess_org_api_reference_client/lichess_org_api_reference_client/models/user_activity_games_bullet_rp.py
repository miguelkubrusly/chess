...
T = TypeVar("T", bound="UserActivityGamesBulletRp")



@_attrs_define
class UserActivityGamesBulletRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_bullet_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_bullet_rp.additional_properties = d
        return user_activity_games_bullet_rp
