...
if TYPE_CHECKING:
  from ..models.broadcasts_by_user_response_200_current_page_results_item_tour_info import BroadcastsByUserResponse200CurrentPageResultsItemTourInfo





T = TypeVar("T", bound="BroadcastsByUserResponse200CurrentPageResultsItemTour")



@_attrs_define
class BroadcastsByUserResponse200CurrentPageResultsItemTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastsByUserResponse200CurrentPageResultsItemTourInfo]): Additional display information
    ...
    info: Union[Unset, 'BroadcastsByUserResponse200CurrentPageResultsItemTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastsByUserResponse200CurrentPageResultsItemTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastsByUserResponse200CurrentPageResultsItemTourInfo.from_dict(_info)
        ...
        broadcasts_by_user_response_200_current_page_results_item_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcasts_by_user_response_200_current_page_results_item_tour.additional_properties = d
        return broadcasts_by_user_response_200_current_page_results_item_tour
