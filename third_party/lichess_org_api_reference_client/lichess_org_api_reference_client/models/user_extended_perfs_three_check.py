...
T = TypeVar("T", bound="UserExtendedPerfsThreeCheck")



@_attrs_define
class UserExtendedPerfsThreeCheck:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_three_check = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_three_check.additional_properties = d
        return user_extended_perfs_three_check
