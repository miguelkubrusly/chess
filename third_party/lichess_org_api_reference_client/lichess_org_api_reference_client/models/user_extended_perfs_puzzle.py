...
T = TypeVar("T", bound="UserExtendedPerfsPuzzle")



@_attrs_define
class UserExtendedPerfsPuzzle:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_puzzle = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_puzzle.additional_properties = d
        return user_extended_perfs_puzzle
