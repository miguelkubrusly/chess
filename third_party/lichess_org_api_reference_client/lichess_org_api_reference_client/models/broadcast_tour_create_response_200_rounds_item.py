...
if TYPE_CHECKING:
  from ..models.broadcast_tour_create_response_200_rounds_item_custom_scoring import BroadcastTourCreateResponse200RoundsItemCustomScoring





T = TypeVar("T", bound="BroadcastTourCreateResponse200RoundsItem")



@_attrs_define
class BroadcastTourCreateResponse200RoundsItem:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastTourCreateResponse200RoundsItemCustomScoring]): Scoring overrides for wins
                or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastTourCreateResponse200RoundsItemCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastTourCreateResponse200RoundsItemCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastTourCreateResponse200RoundsItemCustomScoring.from_dict(_custom_scoring)




        broadcast_tour_create_response_200_rounds_item = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_tour_create_response_200_rounds_item.additional_properties = d
        return broadcast_tour_create_response_200_rounds_item
