...
T = TypeVar("T", bound="ChallengeListResponse200InItemUnlimited")



@_attrs_define
class ChallengeListResponse200InItemUnlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_list_response_200_in_item_unlimited = cls(
            type_=type_,
        )

        return challenge_list_response_200_in_item_unlimited
