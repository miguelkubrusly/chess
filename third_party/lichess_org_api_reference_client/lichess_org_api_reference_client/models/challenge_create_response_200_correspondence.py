...
T = TypeVar("T", bound="ChallengeCreateResponse200Correspondence")



@_attrs_define
class ChallengeCreateResponse200Correspondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_create_response_200_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_create_response_200_correspondence
