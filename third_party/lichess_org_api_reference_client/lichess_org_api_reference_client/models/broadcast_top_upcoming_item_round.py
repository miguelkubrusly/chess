...
if TYPE_CHECKING:
  from ..models.broadcast_top_upcoming_item_round_custom_scoring import BroadcastTopUpcomingItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastTopUpcomingItemRound")



@_attrs_define
class BroadcastTopUpcomingItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastTopUpcomingItemRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastTopUpcomingItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastTopUpcomingItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastTopUpcomingItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_top_upcoming_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_top_upcoming_item_round.additional_properties = d
        return broadcast_top_upcoming_item_round
