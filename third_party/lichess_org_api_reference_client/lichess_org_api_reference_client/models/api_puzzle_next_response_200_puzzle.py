...
T = TypeVar("T", bound="ApiPuzzleNextResponse200Puzzle")



@_attrs_define
class ApiPuzzleNextResponse200Puzzle:
    """ 
        Attributes:
            id (str):
            initial_ply (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_puzzle_next_response_200_puzzle = cls(
            id=id,
        ...
        return api_puzzle_next_response_200_puzzle
