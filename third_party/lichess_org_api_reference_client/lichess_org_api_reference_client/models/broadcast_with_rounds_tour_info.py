...
from ..models.broadcast_with_rounds_tour_info_fide_tc import BroadcastWithRoundsTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastWithRoundsTourInfo")



@_attrs_define
class BroadcastWithRoundsTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastWithRoundsTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastWithRoundsTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastWithRoundsTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastWithRoundsTourInfoFideTc(_fide_tc)
        ...
        broadcast_with_rounds_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_with_rounds_tour_info.additional_properties = d
        return broadcast_with_rounds_tour_info
