...
if TYPE_CHECKING:
  from ..models.broadcast_my_round_round_custom_scoring import BroadcastMyRoundRoundCustomScoring





T = TypeVar("T", bound="BroadcastMyRoundRound")



@_attrs_define
class BroadcastMyRoundRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastMyRoundRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastMyRoundRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastMyRoundRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastMyRoundRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_my_round_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_my_round_round.additional_properties = d
        return broadcast_my_round_round
