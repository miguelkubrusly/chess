...
from ..models.fide_player_get_response_200_title import FidePlayerGetResponse200Title
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="FidePlayerGetResponse200")



@_attrs_define
class FidePlayerGetResponse200:
    """ 
        Attributes:
            id (int):
            name (str):
            federation (str):
            title (Union[Unset, FidePlayerGetResponse200Title]): only appears if the user is a titled player or a bot user
    ...
    name: str
    federation: str
    title: Union[Unset, FidePlayerGetResponse200Title] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, FidePlayerGetResponse200Title]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = FidePlayerGetResponse200Title(_title)
        ...
        fide_player_get_response_200 = cls(
            id=id,
            name=name,
            federation=federation,
            title=title,
        ...
        fide_player_get_response_200.additional_properties = d
        return fide_player_get_response_200
