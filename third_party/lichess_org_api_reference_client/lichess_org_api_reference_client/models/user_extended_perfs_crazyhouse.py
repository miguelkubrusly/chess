...
T = TypeVar("T", bound="UserExtendedPerfsCrazyhouse")



@_attrs_define
class UserExtendedPerfsCrazyhouse:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_crazyhouse = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_crazyhouse.additional_properties = d
        return user_extended_perfs_crazyhouse
