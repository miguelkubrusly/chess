...
if TYPE_CHECKING:
  from ..models.user_play_time import UserPlayTime
  from ..models.user_perfs import UserPerfs
...
class User:
    """ 
        Attributes:
            ...
            perfs (Union[Unset, UserPerfs]):
            title (Union[Unset, UserTitle]): only appears if the user is a titled player or a bot user
            ...
            play_time (Union[Unset, UserPlayTime]):
    ...
    id: str
    username: str
    perfs: Union[Unset, 'UserPerfs'] = UNSET
    title: Union[Unset, UserTitle] = UNSET
    ...
    play_time: Union[Unset, 'UserPlayTime'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_perfs,  Unset):
            ...
            perfs = UserPerfs.from_dict(_perfs)




        _title = d.pop("title", UNSET)
        title: Union[Unset, UserTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = UserTitle(_title)
        ...
        if isinstance(_play_time,  Unset):
            ...
            play_time = UserPlayTime.from_dict(_play_time)
