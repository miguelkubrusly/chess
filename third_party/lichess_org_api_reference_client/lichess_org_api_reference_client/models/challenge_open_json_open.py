...
T = TypeVar("T", bound="ChallengeOpenJsonOpen")



@_attrs_define
class ChallengeOpenJsonOpen:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_open_json_open = cls(
            user_ids=user_ids,
        )


        challenge_open_json_open.additional_properties = d
        return challenge_open_json_open
