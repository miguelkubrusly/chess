...
T = TypeVar("T", bound="ChallengeDeclinedJsonCorrespondence")



@_attrs_define
class ChallengeDeclinedJsonCorrespondence:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_declined_json_correspondence = cls(
            type_=type_,
            days_per_turn=days_per_turn,
        )

        return challenge_declined_json_correspondence
