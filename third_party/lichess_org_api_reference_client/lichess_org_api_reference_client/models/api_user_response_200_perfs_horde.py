...
T = TypeVar("T", bound="ApiUserResponse200PerfsHorde")



@_attrs_define
class ApiUserResponse200PerfsHorde:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_user_response_200_perfs_horde = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        api_user_response_200_perfs_horde.additional_properties = d
        return api_user_response_200_perfs_horde
