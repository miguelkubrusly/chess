...
from ..models.broadcasts_top_response_200_past_current_page_results_item_tour_info_fide_tc import BroadcastsTopResponse200PastCurrentPageResultsItemTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo")



@_attrs_define
class BroadcastsTopResponse200PastCurrentPageResultsItemTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastsTopResponse200PastCurrentPageResultsItemTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastsTopResponse200PastCurrentPageResultsItemTourInfoFideTc(_fide_tc)
        ...
        broadcasts_top_response_200_past_current_page_results_item_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcasts_top_response_200_past_current_page_results_item_tour_info.additional_properties = d
        return broadcasts_top_response_200_past_current_page_results_item_tour_info
