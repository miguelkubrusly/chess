...
T = TypeVar("T", bound="GameUsersBlackAnalysis")



@_attrs_define
class GameUsersBlackAnalysis:
    """ 
        Attributes:
            inaccuracy (float):
            mistake (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_users_black_analysis.additional_properties = d
        return game_users_black_analysis
