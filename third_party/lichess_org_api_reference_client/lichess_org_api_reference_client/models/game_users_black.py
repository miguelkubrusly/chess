...
if TYPE_CHECKING:
  from ..models.game_users_black_user import GameUsersBlackUser
  from ..models.game_users_black_analysis import GameUsersBlackAnalysis





T = TypeVar("T", bound="GameUsersBlack")



@_attrs_define
class GameUsersBlack:
    """ 
        Attributes:
            user (GameUsersBlackUser):
            rating (int):
            rating_diff (Union[Unset, int]):
            name (Union[Unset, str]):
            provisional (Union[Unset, bool]):
            ai_level (Union[Unset, int]):
            analysis (Union[Unset, GameUsersBlackAnalysis]):
    ...
    analysis: Union[Unset, 'GameUsersBlackAnalysis'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.game_users_black_analysis import GameUsersBlackAnalysis
        d = dict(src_dict)
        user = GameUsersBlackUser.from_dict(d.pop("user"))
        ...
        if isinstance(_analysis,  Unset):
            ...
            analysis = GameUsersBlackAnalysis.from_dict(_analysis)
        ...
        game_users_black.additional_properties = d
        return game_users_black
