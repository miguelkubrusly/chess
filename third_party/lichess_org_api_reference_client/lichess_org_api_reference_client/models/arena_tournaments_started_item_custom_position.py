...
T = TypeVar("T", bound="ArenaTournamentsStartedItemCustomPosition")



@_attrs_define
class ArenaTournamentsStartedItemCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_started_item_custom_position = cls(
            name=name,
            fen=fen,
        )


        arena_tournaments_started_item_custom_position.additional_properties = d
        return arena_tournaments_started_item_custom_position
