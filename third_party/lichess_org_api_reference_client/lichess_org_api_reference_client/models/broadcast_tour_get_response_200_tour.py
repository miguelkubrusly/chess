...
if TYPE_CHECKING:
  from ..models.broadcast_tour_get_response_200_tour_info import BroadcastTourGetResponse200TourInfo





T = TypeVar("T", bound="BroadcastTourGetResponse200Tour")



@_attrs_define
class BroadcastTourGetResponse200Tour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastTourGetResponse200TourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastTourGetResponse200TourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastTourGetResponse200TourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastTourGetResponse200TourInfo.from_dict(_info)
        ...
        broadcast_tour_get_response_200_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_tour_get_response_200_tour.additional_properties = d
        return broadcast_tour_get_response_200_tour
