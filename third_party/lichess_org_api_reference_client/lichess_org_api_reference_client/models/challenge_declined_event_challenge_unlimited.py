...
T = TypeVar("T", bound="ChallengeDeclinedEventChallengeUnlimited")



@_attrs_define
class ChallengeDeclinedEventChallengeUnlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_declined_event_challenge_unlimited = cls(
            type_=type_,
        )

        return challenge_declined_event_challenge_unlimited
