...
if TYPE_CHECKING:
  from ..models.team_all_response_200_current_page_results_item_leaders_item import TeamAllResponse200CurrentPageResultsItemLeadersItem
  from ..models.team_all_response_200_current_page_results_item_leader import TeamAllResponse200CurrentPageResultsItemLeader





T = TypeVar("T", bound="TeamAllResponse200CurrentPageResultsItem")



@_attrs_define
class TeamAllResponse200CurrentPageResultsItem:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            leader (Union[Unset, TeamAllResponse200CurrentPageResultsItemLeader]):
            leaders (Union[Unset, list['TeamAllResponse200CurrentPageResultsItemLeadersItem']]):
    ...
    leader: Union[Unset, 'TeamAllResponse200CurrentPageResultsItemLeader'] = UNSET
    leaders: Union[Unset, list['TeamAllResponse200CurrentPageResultsItemLeadersItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_leader,  Unset):
            ...
            leader = TeamAllResponse200CurrentPageResultsItemLeader.from_dict(_leader)
        ...
        for leaders_item_data in (_leaders or []):
            leaders_item = TeamAllResponse200CurrentPageResultsItemLeadersItem.from_dict(leaders_item_data)
        ...
        team_all_response_200_current_page_results_item = cls(
            id=id,
            name=name,
        ...
        team_all_response_200_current_page_results_item.additional_properties = d
        return team_all_response_200_current_page_results_item
