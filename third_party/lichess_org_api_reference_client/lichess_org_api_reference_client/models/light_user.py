...
from ..models.light_user_title import LightUserTitle
from ..types import UNSET, Unset
...
class LightUser:
    """ 
        Attributes:
            ...
            title (Union[Unset, LightUserTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, LightUserTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, LightUserTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = LightUserTitle(_title)
