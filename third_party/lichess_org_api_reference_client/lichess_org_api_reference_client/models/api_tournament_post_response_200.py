...
if TYPE_CHECKING:
  from ..models.api_tournament_post_response_200_spotlight import ApiTournamentPostResponse200Spotlight
  from ..models.api_tournament_post_response_200_stats import ApiTournamentPostResponse200Stats
  from ..models.api_tournament_post_response_200_quote import ApiTournamentPostResponse200Quote
  from ..models.api_tournament_post_response_200_standing import ApiTournamentPostResponse200Standing
  from ..models.api_tournament_post_response_200_verdicts import ApiTournamentPostResponse200Verdicts
  from ..models.api_tournament_post_response_200_schedule import ApiTournamentPostResponse200Schedule
  from ..models.api_tournament_post_response_200_min_rating import ApiTournamentPostResponse200MinRating
  from ..models.api_tournament_post_response_200_duels_item import ApiTournamentPostResponse200DuelsItem
  from ..models.api_tournament_post_response_200_featured import ApiTournamentPostResponse200Featured
  from ..models.api_tournament_post_response_200_podium_item import ApiTournamentPostResponse200PodiumItem
  from ..models.api_tournament_post_response_200_max_rating import ApiTournamentPostResponse200MaxRating
  from ..models.api_tournament_post_response_200_min_rated_games import ApiTournamentPostResponse200MinRatedGames
  from ..models.api_tournament_post_response_200_great_player import ApiTournamentPostResponse200GreatPlayer
  from ..models.api_tournament_post_response_200_clock import ApiTournamentPostResponse200Clock
  from ..models.api_tournament_post_response_200_perf import ApiTournamentPostResponse200Perf





T = TypeVar("T", bound="ApiTournamentPostResponse200")



@_attrs_define
class ApiTournamentPostResponse200:
    """ 
        Attributes:
            id (str):
            full_name (str):
            clock (ApiTournamentPostResponse200Clock):
            nb_players (float):
            rated (Union[Unset, bool]):
            spotlight (Union[Unset, ApiTournamentPostResponse200Spotlight]):
            ...
            verdicts (Union[Unset, ApiTournamentPostResponse200Verdicts]):
            quote (Union[Unset, ApiTournamentPostResponse200Quote]): The quote displayed on the tournament page
            great_player (Union[Unset, ApiTournamentPostResponse200GreatPlayer]):
            allow_list (Union[Unset, list[str]]): List of usernames allowed to join the tournament
            has_max_rating (Union[Unset, bool]):
            max_rating (Union[Unset, ApiTournamentPostResponse200MaxRating]):
            min_rating (Union[Unset, ApiTournamentPostResponse200MinRating]):
            min_rated_games (Union[Unset, ApiTournamentPostResponse200MinRatedGames]):
            bots_allowed (Union[Unset, bool]):
            min_account_age_in_days (Union[Unset, int]):
            perf (Union[Unset, ApiTournamentPostResponse200Perf]):
            schedule (Union[Unset, ApiTournamentPostResponse200Schedule]):
            description (Union[Unset, str]):
            variant (Union[Unset, str]):
            duels (Union[Unset, list['ApiTournamentPostResponse200DuelsItem']]):
            standing (Union[Unset, ApiTournamentPostResponse200Standing]):
            featured (Union[Unset, ApiTournamentPostResponse200Featured]):
            podium (Union[Unset, list['ApiTournamentPostResponse200PodiumItem']]):
            stats (Union[Unset, ApiTournamentPostResponse200Stats]):
    ...
    spotlight: Union[Unset, 'ApiTournamentPostResponse200Spotlight'] = UNSET
    ...
    verdicts: Union[Unset, 'ApiTournamentPostResponse200Verdicts'] = UNSET
    quote: Union[Unset, 'ApiTournamentPostResponse200Quote'] = UNSET
    great_player: Union[Unset, 'ApiTournamentPostResponse200GreatPlayer'] = UNSET
    allow_list: Union[Unset, list[str]] = UNSET
    has_max_rating: Union[Unset, bool] = UNSET
    max_rating: Union[Unset, 'ApiTournamentPostResponse200MaxRating'] = UNSET
    min_rating: Union[Unset, 'ApiTournamentPostResponse200MinRating'] = UNSET
    min_rated_games: Union[Unset, 'ApiTournamentPostResponse200MinRatedGames'] = UNSET
    bots_allowed: Union[Unset, bool] = UNSET
    min_account_age_in_days: Union[Unset, int] = UNSET
    perf: Union[Unset, 'ApiTournamentPostResponse200Perf'] = UNSET
    schedule: Union[Unset, 'ApiTournamentPostResponse200Schedule'] = UNSET
    description: Union[Unset, str] = UNSET
    variant: Union[Unset, str] = UNSET
    duels: Union[Unset, list['ApiTournamentPostResponse200DuelsItem']] = UNSET
    standing: Union[Unset, 'ApiTournamentPostResponse200Standing'] = UNSET
    featured: Union[Unset, 'ApiTournamentPostResponse200Featured'] = UNSET
    podium: Union[Unset, list['ApiTournamentPostResponse200PodiumItem']] = UNSET
    stats: Union[Unset, 'ApiTournamentPostResponse200Stats'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clock = ApiTournamentPostResponse200Clock.from_dict(d.pop("clock"))
        ...
        if isinstance(_spotlight,  Unset):
            ...
            spotlight = ApiTournamentPostResponse200Spotlight.from_dict(_spotlight)
        ...
        if isinstance(_verdicts,  Unset):
            ...
            verdicts = ApiTournamentPostResponse200Verdicts.from_dict(_verdicts)




        _quote = d.pop("quote", UNSET)
        quote: Union[Unset, ApiTournamentPostResponse200Quote]
        if isinstance(_quote,  Unset):
            quote = UNSET
        else:
            quote = ApiTournamentPostResponse200Quote.from_dict(_quote)
        ...
        if isinstance(_great_player,  Unset):
            ...
            great_player = ApiTournamentPostResponse200GreatPlayer.from_dict(_great_player)
        ...
        if isinstance(_max_rating,  Unset):
            ...
            max_rating = ApiTournamentPostResponse200MaxRating.from_dict(_max_rating)
        ...
        if isinstance(_min_rating,  Unset):
            ...
            min_rating = ApiTournamentPostResponse200MinRating.from_dict(_min_rating)
        ...
        if isinstance(_min_rated_games,  Unset):
            ...
            min_rated_games = ApiTournamentPostResponse200MinRatedGames.from_dict(_min_rated_games)
        ...
        if isinstance(_perf,  Unset):
            ...
            perf = ApiTournamentPostResponse200Perf.from_dict(_perf)
        ...
        if isinstance(_schedule,  Unset):
            ...
            schedule = ApiTournamentPostResponse200Schedule.from_dict(_schedule)
        ...
        for duels_item_data in (_duels or []):
            duels_item = ApiTournamentPostResponse200DuelsItem.from_dict(duels_item_data)
        ...
        if isinstance(_standing,  Unset):
            ...
            standing = ApiTournamentPostResponse200Standing.from_dict(_standing)
        ...
        if isinstance(_featured,  Unset):
            ...
            featured = ApiTournamentPostResponse200Featured.from_dict(_featured)
        ...
        for podium_item_data in (_podium or []):
            podium_item = ApiTournamentPostResponse200PodiumItem.from_dict(podium_item_data)
        ...
        if isinstance(_stats,  Unset):
            ...
            stats = ApiTournamentPostResponse200Stats.from_dict(_stats)
        ...
        api_tournament_post_response_200 = cls(
            id=id,
            full_name=full_name,
            clock=clock,
        ...
        api_tournament_post_response_200.additional_properties = d
        return api_tournament_post_response_200
