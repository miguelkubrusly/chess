...
T = TypeVar("T", bound="UserPerfsChess960")



@_attrs_define
class UserPerfsChess960:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_chess_960.additional_properties = d
        return user_perfs_chess_960
