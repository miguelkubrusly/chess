...
T = TypeVar("T", bound="ApiTournamentPostResponse200PodiumItemNb")



@_attrs_define
class ApiTournamentPostResponse200PodiumItemNb:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_tournament_post_response_200_podium_item_nb = cls(
            game=game,
            berserk=berserk,
            win=win,
        )
        ...
        api_tournament_post_response_200_podium_item_nb.additional_properties = d
        return api_tournament_post_response_200_podium_item_nb
