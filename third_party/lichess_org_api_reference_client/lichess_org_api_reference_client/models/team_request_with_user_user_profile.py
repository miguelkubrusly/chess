...
T = TypeVar("T", bound="TeamRequestWithUserUserProfile")



@_attrs_define
class TeamRequestWithUserUserProfile:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        team_request_with_user_user_profile = cls(
            flag=flag,
            location=location,
            bio=bio,
            real_name=real_name,
        ...
        team_request_with_user_user_profile.additional_properties = d
        return team_request_with_user_user_profile
