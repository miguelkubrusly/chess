...
if TYPE_CHECKING:
  from ..models.api_simul_response_200_started_item_variants_item import ApiSimulResponse200StartedItemVariantsItem
  from ..models.api_simul_response_200_started_item_host import ApiSimulResponse200StartedItemHost





T = TypeVar("T", bound="ApiSimulResponse200StartedItem")



@_attrs_define
class ApiSimulResponse200StartedItem:
    """ 
        Attributes:
            id (str):
            host (ApiSimulResponse200StartedItemHost):
            name (str):
            full_name (str):
            variants (list['ApiSimulResponse200StartedItemVariantsItem']):
            is_created (bool):
            is_finished (bool):
            is_running (bool):
            nb_applicants (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host = ApiSimulResponse200StartedItemHost.from_dict(d.pop("host"))
        ...
        for variants_item_data in (_variants):
            variants_item = ApiSimulResponse200StartedItemVariantsItem.from_dict(variants_item_data)
        ...
        api_simul_response_200_started_item = cls(
            id=id,
            host=host,
            name=name,
            full_name=full_name,
        ...
        api_simul_response_200_started_item.additional_properties = d
        return api_simul_response_200_started_item
