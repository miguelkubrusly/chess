...
T = TypeVar("T", bound="ApiUserResponse200PerfsBlitz")



@_attrs_define
class ApiUserResponse200PerfsBlitz:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_user_response_200_perfs_blitz = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        api_user_response_200_perfs_blitz.additional_properties = d
        return api_user_response_200_perfs_blitz
