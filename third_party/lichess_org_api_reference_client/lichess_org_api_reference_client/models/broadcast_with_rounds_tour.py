...
if TYPE_CHECKING:
  from ..models.broadcast_with_rounds_tour_info import BroadcastWithRoundsTourInfo





T = TypeVar("T", bound="BroadcastWithRoundsTour")



@_attrs_define
class BroadcastWithRoundsTour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastWithRoundsTourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastWithRoundsTourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastWithRoundsTourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastWithRoundsTourInfo.from_dict(_info)
        ...
        broadcast_with_rounds_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_with_rounds_tour.additional_properties = d
        return broadcast_with_rounds_tour
