...
T = TypeVar("T", bound="ArenaTournamentPlayedTournamentThematic")



@_attrs_define
class ArenaTournamentPlayedTournamentThematic:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournament_played_tournament_thematic = cls(
            eco=eco,
            name=name,
            fen=fen,
            url=url,
        ...
        arena_tournament_played_tournament_thematic.additional_properties = d
        return arena_tournament_played_tournament_thematic
