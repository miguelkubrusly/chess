...
T = TypeVar("T", bound="UserExtendedPerfsHorde")



@_attrs_define
class UserExtendedPerfsHorde:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_horde.additional_properties = d
        return user_extended_perfs_horde
