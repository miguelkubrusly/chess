...
T = TypeVar("T", bound="ArenaTournamentFullPodiumItemNb")



@_attrs_define
class ArenaTournamentFullPodiumItemNb:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournament_full_podium_item_nb = cls(
            game=game,
            berserk=berserk,
            win=win,
        )
        ...
        arena_tournament_full_podium_item_nb.additional_properties = d
        return arena_tournament_full_podium_item_nb
