...
T = TypeVar("T", bound="ArenaTournamentsCreatedItemCustomPosition")



@_attrs_define
class ArenaTournamentsCreatedItemCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_created_item_custom_position = cls(
            name=name,
            fen=fen,
        )


        arena_tournaments_created_item_custom_position.additional_properties = d
        return arena_tournaments_created_item_custom_position
