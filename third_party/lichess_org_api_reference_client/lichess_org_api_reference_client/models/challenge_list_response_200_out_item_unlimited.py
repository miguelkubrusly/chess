...
T = TypeVar("T", bound="ChallengeListResponse200OutItemUnlimited")



@_attrs_define
class ChallengeListResponse200OutItemUnlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_list_response_200_out_item_unlimited = cls(
            type_=type_,
        )

        return challenge_list_response_200_out_item_unlimited
