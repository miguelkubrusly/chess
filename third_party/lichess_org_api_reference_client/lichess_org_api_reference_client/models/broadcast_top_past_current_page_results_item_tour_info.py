...
from ..models.broadcast_top_past_current_page_results_item_tour_info_fide_tc import BroadcastTopPastCurrentPageResultsItemTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastTopPastCurrentPageResultsItemTourInfo")



@_attrs_define
class BroadcastTopPastCurrentPageResultsItemTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastTopPastCurrentPageResultsItemTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastTopPastCurrentPageResultsItemTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastTopPastCurrentPageResultsItemTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastTopPastCurrentPageResultsItemTourInfoFideTc(_fide_tc)
        ...
        broadcast_top_past_current_page_results_item_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_top_past_current_page_results_item_tour_info.additional_properties = d
        return broadcast_top_past_current_page_results_item_tour_info
