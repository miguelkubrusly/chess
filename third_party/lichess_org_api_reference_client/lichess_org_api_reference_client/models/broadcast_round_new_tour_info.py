...
from ..models.broadcast_round_new_tour_info_fide_tc import BroadcastRoundNewTourInfoFideTc
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastRoundNewTourInfo")



@_attrs_define
class BroadcastRoundNewTourInfo:
    """ Additional display information about the tournament
        ...
        Attributes:
            ...
            fide_tc (Union[Unset, BroadcastRoundNewTourInfoFideTc]): FIDE rating category
    ...
    fide_tc: Union[Unset, BroadcastRoundNewTourInfoFideTc] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fide_tc: Union[Unset, BroadcastRoundNewTourInfoFideTc]
        if isinstance(_fide_tc,  Unset):
            fide_tc = UNSET
        else:
            fide_tc = BroadcastRoundNewTourInfoFideTc(_fide_tc)
        ...
        broadcast_round_new_tour_info = cls(
            website=website,
            players=players,
            location=location,
            tc=tc,
        ...
        broadcast_round_new_tour_info.additional_properties = d
        return broadcast_round_new_tour_info
