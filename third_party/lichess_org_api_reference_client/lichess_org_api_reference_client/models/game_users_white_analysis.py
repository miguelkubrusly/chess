...
T = TypeVar("T", bound="GameUsersWhiteAnalysis")



@_attrs_define
class GameUsersWhiteAnalysis:
    """ 
        Attributes:
            inaccuracy (float):
            mistake (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        game_users_white_analysis.additional_properties = d
        return game_users_white_analysis
