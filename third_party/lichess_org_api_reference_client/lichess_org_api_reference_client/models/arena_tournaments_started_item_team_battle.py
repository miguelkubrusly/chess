...
T = TypeVar("T", bound="ArenaTournamentsStartedItemTeamBattle")



@_attrs_define
class ArenaTournamentsStartedItemTeamBattle:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        arena_tournaments_started_item_team_battle = cls(
            teams=teams,
            nb_leaders=nb_leaders,
        )


        arena_tournaments_started_item_team_battle.additional_properties = d
        return arena_tournaments_started_item_team_battle
