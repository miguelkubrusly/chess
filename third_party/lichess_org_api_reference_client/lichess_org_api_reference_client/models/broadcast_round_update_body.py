...
from ..models.broadcast_round_update_body_status import BroadcastRoundUpdateBodyStatus
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="BroadcastRoundUpdateBody")



@_attrs_define
class BroadcastRoundUpdateBody:
    """ 
        Attributes:
            ...
            delay (Union[Unset, int]): Delay in seconds for movements to appear on the broadcast. Leave it empty if you
                don't need it.
                Example: `900` (15 min)
            status (Union[Unset, BroadcastRoundUpdateBodyStatus]): Lichess can usually detect the round status, but you can
                also set it manually if needed.
                 Default: BroadcastRoundUpdateBodyStatus.NEW.
    ...
    status: Union[Unset, BroadcastRoundUpdateBodyStatus] = BroadcastRoundUpdateBodyStatus.NEW
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: Union[Unset, BroadcastRoundUpdateBodyStatus]
        if isinstance(_status,  Unset):
            status = UNSET
        else:
            status = BroadcastRoundUpdateBodyStatus(_status)
        ...
        broadcast_round_update_body = cls(
            starts_at=starts_at,
        ...
        broadcast_round_update_body.additional_properties = d
        return broadcast_round_update_body
