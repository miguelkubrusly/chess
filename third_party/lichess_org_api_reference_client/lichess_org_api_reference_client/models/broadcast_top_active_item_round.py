...
if TYPE_CHECKING:
  from ..models.broadcast_top_active_item_round_custom_scoring import BroadcastTopActiveItemRoundCustomScoring





T = TypeVar("T", bound="BroadcastTopActiveItemRound")



@_attrs_define
class BroadcastTopActiveItemRound:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            custom_scoring (Union[Unset, BroadcastTopActiveItemRoundCustomScoring]): Scoring overrides for wins or draws.
     """
    ...
    custom_scoring: Union[Unset, 'BroadcastTopActiveItemRoundCustomScoring'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_scoring: Union[Unset, BroadcastTopActiveItemRoundCustomScoring]
        if isinstance(_custom_scoring,  Unset):
            custom_scoring = UNSET
        else:
            custom_scoring = BroadcastTopActiveItemRoundCustomScoring.from_dict(_custom_scoring)




        broadcast_top_active_item_round = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_top_active_item_round.additional_properties = d
        return broadcast_top_active_item_round
