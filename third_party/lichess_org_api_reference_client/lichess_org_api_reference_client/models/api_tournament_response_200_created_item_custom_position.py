...
T = TypeVar("T", bound="ApiTournamentResponse200CreatedItemCustomPosition")



@_attrs_define
class ApiTournamentResponse200CreatedItemCustomPosition:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_tournament_response_200_created_item_custom_position = cls(
            name=name,
            fen=fen,
        )


        api_tournament_response_200_created_item_custom_position.additional_properties = d
        return api_tournament_response_200_created_item_custom_position
