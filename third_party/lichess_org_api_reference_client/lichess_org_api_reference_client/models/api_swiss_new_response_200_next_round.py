...
T = TypeVar("T", bound="ApiSwissNewResponse200NextRound")



@_attrs_define
class ApiSwissNewResponse200NextRound:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_swiss_new_response_200_next_round = cls(
            at=at,
            in_=in_,
        )


        api_swiss_new_response_200_next_round.additional_properties = d
        return api_swiss_new_response_200_next_round
