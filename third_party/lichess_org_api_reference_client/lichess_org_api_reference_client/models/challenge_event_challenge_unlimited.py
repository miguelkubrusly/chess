...
T = TypeVar("T", bound="ChallengeEventChallengeUnlimited")



@_attrs_define
class ChallengeEventChallengeUnlimited:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_event_challenge_unlimited = cls(
            type_=type_,
        )

        return challenge_event_challenge_unlimited
