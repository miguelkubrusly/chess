...
T = TypeVar("T", bound="UserPerfsKingOfTheHill")



@_attrs_define
class UserPerfsKingOfTheHill:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_king_of_the_hill = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_perfs_king_of_the_hill.additional_properties = d
        return user_perfs_king_of_the_hill
