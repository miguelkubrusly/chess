...
from ..models.api_external_engine_create_response_200_variants_item import ApiExternalEngineCreateResponse200VariantsItem
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ApiExternalEngineCreateResponse200")



@_attrs_define
class ApiExternalEngineCreateResponse200:
    """ 
        Attributes:
            ...
            variants (list[ApiExternalEngineCreateResponse200VariantsItem]): List of supported chess variants.
    ...
    max_threads: int
    max_hash: int
    variants: list[ApiExternalEngineCreateResponse200VariantsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in (_variants):
            variants_item = ApiExternalEngineCreateResponse200VariantsItem(variants_item_data)
        ...
        api_external_engine_create_response_200 = cls(
            id=id,
            name=name,
        ...
        api_external_engine_create_response_200.additional_properties = d
        return api_external_engine_create_response_200
