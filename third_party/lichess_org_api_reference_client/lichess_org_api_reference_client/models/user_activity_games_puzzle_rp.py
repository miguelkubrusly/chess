...
T = TypeVar("T", bound="UserActivityGamesPuzzleRp")



@_attrs_define
class UserActivityGamesPuzzleRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_puzzle_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_puzzle_rp.additional_properties = d
        return user_activity_games_puzzle_rp
