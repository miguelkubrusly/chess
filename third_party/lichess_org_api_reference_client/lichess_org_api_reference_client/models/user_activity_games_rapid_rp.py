...
T = TypeVar("T", bound="UserActivityGamesRapidRp")



@_attrs_define
class UserActivityGamesRapidRp:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_activity_games_rapid_rp = cls(
            before=before,
            after=after,
        )


        user_activity_games_rapid_rp.additional_properties = d
        return user_activity_games_rapid_rp
