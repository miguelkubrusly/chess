...
if TYPE_CHECKING:
  from ..models.broadcast_round_get_response_200_tour_info import BroadcastRoundGetResponse200TourInfo





T = TypeVar("T", bound="BroadcastRoundGetResponse200Tour")



@_attrs_define
class BroadcastRoundGetResponse200Tour:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            info (Union[Unset, BroadcastRoundGetResponse200TourInfo]): Additional display information about the tournament
    ...
    info: Union[Unset, 'BroadcastRoundGetResponse200TourInfo'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        info: Union[Unset, BroadcastRoundGetResponse200TourInfo]
        if isinstance(_info,  Unset):
            info = UNSET
        else:
            info = BroadcastRoundGetResponse200TourInfo.from_dict(_info)
        ...
        broadcast_round_get_response_200_tour = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        broadcast_round_get_response_200_tour.additional_properties = d
        return broadcast_round_get_response_200_tour
