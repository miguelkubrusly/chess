...
T = TypeVar("T", bound="UserPerfsThreeCheck")



@_attrs_define
class UserPerfsThreeCheck:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_perfs_three_check.additional_properties = d
        return user_perfs_three_check
