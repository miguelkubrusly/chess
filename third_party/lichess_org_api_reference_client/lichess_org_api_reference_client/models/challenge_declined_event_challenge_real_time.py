...
T = TypeVar("T", bound="ChallengeDeclinedEventChallengeRealTime")



@_attrs_define
class ChallengeDeclinedEventChallengeRealTime:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        challenge_declined_event_challenge_real_time = cls(
            type_=type_,
            limit=limit,
            increment=increment,
            show=show,
        ...
        return challenge_declined_event_challenge_real_time
