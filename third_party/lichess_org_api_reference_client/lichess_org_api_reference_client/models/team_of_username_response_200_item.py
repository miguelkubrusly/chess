...
if TYPE_CHECKING:
  from ..models.team_of_username_response_200_item_leaders_item import TeamOfUsernameResponse200ItemLeadersItem
  from ..models.team_of_username_response_200_item_leader import TeamOfUsernameResponse200ItemLeader





T = TypeVar("T", bound="TeamOfUsernameResponse200Item")



@_attrs_define
class TeamOfUsernameResponse200Item:
    """ 
        Attributes:
            id (str):
            name (str):
            ...
            leader (Union[Unset, TeamOfUsernameResponse200ItemLeader]):
            leaders (Union[Unset, list['TeamOfUsernameResponse200ItemLeadersItem']]):
    ...
    leader: Union[Unset, 'TeamOfUsernameResponse200ItemLeader'] = UNSET
    leaders: Union[Unset, list['TeamOfUsernameResponse200ItemLeadersItem']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_leader,  Unset):
            ...
            leader = TeamOfUsernameResponse200ItemLeader.from_dict(_leader)
        ...
        for leaders_item_data in (_leaders or []):
            leaders_item = TeamOfUsernameResponse200ItemLeadersItem.from_dict(leaders_item_data)
        ...
        team_of_username_response_200_item = cls(
            id=id,
            name=name,
        ...
        team_of_username_response_200_item.additional_properties = d
        return team_of_username_response_200_item
