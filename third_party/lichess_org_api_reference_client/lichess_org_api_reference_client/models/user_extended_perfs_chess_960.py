...
T = TypeVar("T", bound="UserExtendedPerfsChess960")



@_attrs_define
class UserExtendedPerfsChess960:
    """ 
        Attributes:
            games (int):
            rating (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_extended_perfs_chess_960 = cls(
            games=games,
            rating=rating,
            rd=rd,
            prog=prog,
        ...
        user_extended_perfs_chess_960.additional_properties = d
        return user_extended_perfs_chess_960
