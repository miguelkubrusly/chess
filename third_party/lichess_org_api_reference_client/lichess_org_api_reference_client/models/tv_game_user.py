...
from ..models.tv_game_user_title import TvGameUserTitle
from ..types import UNSET, Unset
...
class TvGameUser:
    """ 
        Attributes:
            ...
            title (Union[Unset, TvGameUserTitle]): only appears if the user is a titled player or a bot user
    ...
    title: Union[Unset, TvGameUserTitle] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        title: Union[Unset, TvGameUserTitle]
        if isinstance(_title,  Unset):
            title = UNSET
        else:
            title = TvGameUserTitle(_title)
        ...
        tv_game_user.additional_properties = d
        return tv_game_user
