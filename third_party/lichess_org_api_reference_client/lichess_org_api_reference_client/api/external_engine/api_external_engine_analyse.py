...
from ...models.api_external_engine_analyse_body import ApiExternalEngineAnalyseBody
...
def _get_kwargs(
    id: str,
    *,
    body: ApiExternalEngineAnalyseBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/external-engine/{id}/analyse".format(id=id,),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Response content is streamed as [newline delimited JSON](#section/Introduction/Streaming-with-ND-
    JSON).
