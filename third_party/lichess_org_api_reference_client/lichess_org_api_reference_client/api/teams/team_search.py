...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[TeamSearchResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[TeamSearchResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        text (Union[Unset, str]):  Example: coders.
