...
from ...models.api_team_swiss_status import ApiTeamSwissStatus
...
def _get_kwargs(
    ...
    *,
    ...
    status: Union[Unset, 'ApiTeamSwissStatus'] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/team/{team_id}/swiss".format(team_id=team_id,),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        status (Union[Unset, ApiTeamSwissStatus]):
