...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/tournament/{id}/results".format(id=id,),
        "params": params,
    }
...
def sync_detailed(
    ...
    **Players are streamed as [ndjson](#section/Introduction/Streaming-with-ND-JSON)**, i.e. one JSON
    object per line.
    ...
    Args:
        id (str):
        nb (Union[Unset, int]):
        sheet (Union[Unset, bool]):  Default: False.
